...
| 시스템 | `payment_ledger` | `stable-candidate` | 숨김 기반 모듈 정책 문서, 결제 대상 계약, `check-payment-ledger-runtime.php`, 쿠폰/자산 복합 결제 payment record fixture | 설치 DB 콘텐츠/커뮤니티 결제 mutation smoke와 결제 record/item 확인 |
