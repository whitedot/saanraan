...
| 서비스 | `message` | `beta` | `check-message-policy.php`, `check-privacy-export-runtime.php`, `check-admin-action-security.php`, 쪽지 발신/수신 정책 runtime fixture, 개인정보 export runtime fixture | `release-installed-gate-status.php` 인증 smoke, 쪽지 수발신/삭제/신고/수신 설정 설치 DB mutation smoke |
