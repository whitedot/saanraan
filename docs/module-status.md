...
| 서비스 | `community` | `beta` | `check-community-release.php`, `check-community-privacy-consent.php`, `check-community-board-copy-job-lock.php`, `check-community-attachment-runtime.php`, `check-storage-helpers.php`, `check-asset-idempotency.php`, sanitizer fixture, 개인정보 동의 설정/상속/snapshot runtime fixture, 유료 첨부 접근권 runtime fixture, 공개 목록 썸네일 helper fixture | `release-installed-gate-status.php` 인증 smoke와 자산/쿠폰/유료 접근권 mutation smoke, 게시글/댓글/쪽지/신고/유료 첨부/개인정보 동의 설치 DB mutation smoke |
