...
| 서비스 | `reaction` | `experimental` | 이슈 #326 정책 결정, 설치 SQL 스키마, `check-reaction-runtime.php`, module lifecycle 정적 점검 | 공개/관리자 UI, reaction-target 계약 fixture, write 경로 동시성, 개인정보 smoke |
