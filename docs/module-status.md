...
| 플러그인 | `markdown_editor` | `beta` | `check-markdown-editor-runtime.php`, renderer 계약 fixture, full/inline/plain 출력 fixture, style asset URL과 profile hash fixture, declaration-only custom CSS fixture, 기존 Markdown 저장값 fallback fixture | 설치 DB에서 플러그인 활성/비활성 editor option, 관리자 설정/preview, 콘텐츠/커뮤니티/팝업레이어/약관 문서 Markdown 저장·출력, 업데이트 자동 활성화 smoke |
