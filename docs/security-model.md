...
Toycore는 비즈니스 도메인을 소유하지 않는 절차형 PHP 솔루션 베이스다. 대신 설치, 회원 인증, 관리자 권한, 감사 로그, 개인정보 내보내기, 업데이트 같은 운영 도메인을 코어 기준선으로 제공하고, helper, 정적 검사, dispatch contract 세 층으로 그 기준선을 받친다.
