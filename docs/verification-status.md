...
- `.tools/bin/check-public-call-order.php`는 public route wildcard shadowing, public layout begin/end 균형, output slot을 렌더링하는 public view의 `output_slots` 선선언, 콘텐츠/커뮤니티 본문 embed stylesheet 선계산, public POST mutation의 CSRF 선행 marker를 확인한다.
