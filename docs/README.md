...
[산란 특장점 소개](operator-feature-list.md)는 회원·콘텐츠·커뮤니티·참여 기능·자산·쿠폰·알림·개인정보·사이트 운영 기능이 제공하는 기능과 편의를 정리한다. DB 컬럼, 요청 매핑, 관리자 화면별 상세 필드는 Wiki 또는 [1.0 전 구현 스냅샷](implementation-snapshot.md)을 우선한다.
