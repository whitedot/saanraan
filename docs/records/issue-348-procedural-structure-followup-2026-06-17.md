...
| `modules/community/helpers/assets.php` | 2,467 | 커뮤니티 자산 정책/실행 helper가 함께 있음. 게시자 보상 조회/필터 helper는 별도 파일로 분리함 | 중간 |
...
- `modules/community/helpers/assets.php`의 게시자 보상 상태/필터/목록 조회 helper를 `modules/community/helpers/publisher-rewards.php`로 분리했다.
