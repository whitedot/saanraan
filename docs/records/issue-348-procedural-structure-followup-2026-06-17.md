...
| `modules/community/actions/admin-boards.php` | 1,334 | 게시판 관리자 입력, 검증, 저장, 감사 로그가 긴 문단으로 이어짐 | 중간 |
...
1. `modules/community/actions/admin-boards.php`의 게시판 저장 입력 수집/검증/audit payload 문단을 `sr_community_admin_board_*` helper로 분리한다.
