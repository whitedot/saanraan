...
- 콘텐츠는 콘텐츠 환경설정과 개별 콘텐츠 설정에서 콘텐츠/댓글 리액션 preset을 선택할 수 있다. 실제 적용은 콘텐츠 환경설정 < 개별 콘텐츠 설정 순서로 우선한다.
- 커뮤니티는 커뮤니티 환경설정과 개별 게시판 설정에서 게시글/댓글 리액션 preset을 선택할 수 있다. 실제 적용은 커뮤니티 환경설정 < 개별 게시판 설정 순서로 우선한다.
