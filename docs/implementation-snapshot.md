...
| 퀴즈 | `/quiz`, `GET/POST /quiz/*`, `/quiz/comment`, `/quiz/comment/edit`, `/quiz/comment/delete`, `GET/POST /admin/quiz`, `/admin/quiz/settings`, `/admin/quiz/manual`, `/admin/quiz/attempts`, `/admin/quiz/comments` |
