...
$storage = sr_reaction_icon_image_storage_reference($storageReference);
if (!is_array($storage)) {
    sr_render_error(404, '리액션 아이콘 이미지를 찾을 수 없습니다.');
}
...
if (!sr_reaction_icon_image_mime_is_allowed($mimeType) || !is_int($sizeBytes)) {
    sr_render_error(404, '리액션 아이콘 이미지를 찾을 수 없습니다.');
}
