...
sr_admin_require_permission($pdo, (int) $account['id'], '/admin/points/notification-templates', 'view');
if (sr_request_method() === 'POST') {
    sr_require_csrf();
    sr_admin_require_permission($pdo, (int) $account['id'], '/admin/points/notification-templates', 'edit');
}

sr_notification_event_template_admin_handle($pdo, $site ?? null, [
    'module_key' => 'point',
    'permission_path' => '/admin/points/notification-templates',
    'return_path' => '/admin/points/notification-templates',
    'title' => '포인트 알림/메일 관리',
]);
