...
<section>
    <h2>회원 조회</h2>
    <form method="get" action="<?php echo sr_e(sr_url($pointAdminPage === 'transactions' ? '/admin/points/transactions' : ($pointAdminPage === 'adjust' ? '/admin/points/adjust' : '/admin/points/balances'))); ?>" class="admin-filter-form ui-form-theme">
...
<?php if ($pointAdminPage === 'adjust') { ?>
    <form method="post" action="<?php echo sr_e(sr_url('/admin/points/adjust' . ($accountIdentifierFilter !== '' ? '?account_identifier=' . rawurlencode($accountIdentifierFilter) : ''))); ?>" class="admin-form-layout ui-form-theme ui-form-showcase">
        <section class="card">
            <h2>포인트 조정</h2>
            ...
            <div class="af-row">
                <div class="af-label"><span class="form-label">수량</span></div>
                <div class="af-field">
                    <label>
        ...
        <div class="admin-form-sticky-actions admin-form-actions admin-form-actions-split">
            <a href="<?php echo sr_e(sr_url('/admin/points/balances')); ?>" class="btn btn-surface-default-soft">목록</a>
