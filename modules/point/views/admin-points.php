...
<form method="get" action="<?php echo sr_e(sr_url($pointAdminPage === 'transactions' ? '/admin/points/transactions' : ($pointAdminPage === 'adjust' ? '/admin/points/adjust' : '/admin/points/balances'))); ?>" class="admin-filter admin-asset-member-filter ui-form-theme">
    ...
    <form method="post" action="<?php echo sr_e(sr_url('/admin/points/adjust' . ($accountIdentifierFilter !== '' ? '?account_identifier=' . rawurlencode($accountIdentifierFilter) : ''))); ?>" class="admin-form ui-form-theme">
        <section class="admin-card card">
            ...
            <div class="admin-form-row">
                ...
                <div class="admin-form-field">
                    <input id="point_admin_points_reason" type="text" name="reason" maxlength="255" required class="form-input form-control-full">
                </div>
            </div>
            <div class="admin-form-row">
