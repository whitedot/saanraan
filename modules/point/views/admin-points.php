...
<section>
    <h2>회원 조회</h2>
    <form method="get" action="<?php echo sr_e(sr_url($pointAdminPage === 'transactions' ? '/admin/points/transactions' : ($pointAdminPage === 'adjust' ? '/admin/points/adjust' : '/admin/points/balances'))); ?>">
        <label>회원 공개 해시<br>
