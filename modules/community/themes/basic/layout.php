...
$layoutStylesheets = ['/modules/community/assets/module.css'];
        ...
        <div class="community-layout-actions">
            ...
            <?php if ($layoutMemberEnabled) { ?>
                <?php if (is_array($layoutCurrentAccount)) { ?>
                    ...
                    <?php } ?>
                    <a class="community-layout-icon-button community-layout-member-link community-layout-member-link-account" href="<?php echo sr_e(sr_url('/account')); ?>" aria-label="<?php echo sr_e($layoutMemberDisplayLabel . ' 계정'); ?>">
                    ...
                    <form class="community-layout-member-logout-form" method="post" action="<?php echo sr_e(sr_url('/logout')); ?>">
                        ...
                        <button class="community-layout-icon-button community-layout-member-link community-layout-member-link-logout" type="submit" aria-label="<?php echo sr_e('로그아웃'); ?>">
