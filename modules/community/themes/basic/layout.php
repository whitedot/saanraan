        ...
        <div class="community-layout-actions">
            ...
            <?php if ($layoutMemberEnabled) { ?>
                <?php if (is_array($layoutCurrentAccount)) { ?>
                    <a class="community-layout-icon-button community-layout-member-link community-layout-member-link-account" href="<?php echo sr_e(sr_url('/account')); ?>" aria-label="<?php echo sr_e('내 계정'); ?>">
