...
$layoutStylesheets = [];
$layoutScripts = ['/assets/common-ui.js', '/modules/community/assets/layout.js'];
...
$layoutBusinessInfoHtml = $layoutBusinessInfoVisible ? sr_site_business_info_html($layoutPdo, 'community-layout') : '';
if ($layoutPdo instanceof PDO && sr_module_enabled($layoutPdo, 'logo_manager') && is_file(SR_ROOT . '/modules/logo_manager/helpers.php')) {
    ...
    $layoutFooterBrandLogoHtml = sr_logo_manager_render_logo($layoutPdo, 'public.header.desktop', $layoutSite, [
        'class' => 'community-layout-brand-logo community-layout-footer-logo community-layout-brand-logo-desktop',
        'fallback_position_key' => 'public.header.mobile',
        'layout_provider_key' => 'community',
    ...
    $layoutFooterMobileBrandLogoHtml = sr_logo_manager_render_logo($layoutPdo, 'public.header.mobile', $layoutSite, [
        'class' => $layoutFooterBrandLogoHtml !== ''
            ? 'community-layout-brand-logo community-layout-footer-logo community-layout-brand-logo-mobile'
            : 'community-layout-brand-logo community-layout-footer-logo',
        'fallback_position_key' => 'public.header.desktop',
        'layout_provider_key' => 'community',
        'usage_slot_key' => 'bottom',
        'allow_untargeted_fallback' => false,
...
if ($layoutPdo instanceof PDO) {
    ...
    $layoutModuleBeforeLayoutHtml = sr_render_output_slot($layoutPdo, ['module_key' => 'community', 'point_key' => 'community.layout', 'slot_key' => 'before_layout']);
    $layoutModuleBeforeFooterHtml = sr_render_output_slot($layoutPdo, ['module_key' => 'community', 'point_key' => 'community.layout', 'slot_key' => 'before_footer']);
...
if (
    ...
    if (is_array($layoutCurrentAccount)) {
        ...
        $layoutMemberAssetRows = sr_public_layout_member_asset_rows($layoutPdo, $layoutCurrentAccountId);
...
$layoutRenderedAssetMarkup = implode('', [
    $layoutContent,
    $layoutBeforeLayoutHtml,
    $layoutModuleBeforeLayoutHtml,
    $layoutModuleBeforeFooterHtml,
...
<body class="<?php echo sr_e(trim('community-layout-body example-community-layout-shell ' . $layoutBodyClass)); ?>" data-example-theme-layout="community.sample">
        ...
        <div class="community-layout-topbar">
            ...
            <?php if ($layoutNotificationEnabled) { ?>
                <details class="community-layout-notification-menu">
                    ...
                    <div class="community-layout-notification-dropdown community-layout-notification-box">
            ...
            <?php if ($layoutMemberEnabled) { ?>
                    ...
                    <details class="community-layout-member-menu">
                        ...
                        <div class="community-layout-member-dropdown dropdown-menu-profile" role="menu" aria-orientation="vertical">
                            ...
                            <?php if ($layoutCommunityMemberMenuEnabled) { ?>
                                ...
                                <?php if ($layoutCommunityMessagesEnabled) { ?>
                                    <a class="community-layout-member-dropdown-link dropdown-profile-item" href="<?php echo sr_e(sr_url('/messages')); ?>" role="menuitem">
                ...
                <?php } else { ?>
                    <a class="community-layout-icon-button community-layout-member-link community-layout-member-link-login" href="<?php echo sr_e(sr_member_login_url_for_current_request()); ?>" aria-label="<?php echo sr_e('로그인'); ?>">
    ...
    <footer class="community-layout-footer">
        <div class="community-layout-footer-row">
            <?php if ($layoutFooterBrandLogoHtml !== '' || $layoutFooterMobileBrandLogoHtml !== '') { ?>
                <a class="community-layout-footer-brand-link" href="<?php echo sr_e($layoutBrandLinkUrl); ?>">
                ...
                <div class="community-theme-menu dropdown-menu" role="menu" aria-label="<?php echo sr_e('화면 모드'); ?>">
                    <?php foreach ($layoutColorSchemeOptions as $layoutColorSchemeKey => $layoutColorSchemeLabel) { ?>
                        <button class="community-theme-option dropdown-item" type="button" role="menuitemradio" aria-checked="<?php echo $layoutColorSchemeKey === $layoutColorScheme ? 'true' : 'false'; ?>" data-sr-color-scheme-option="<?php echo sr_e($layoutColorSchemeKey); ?>">
                            ...
                            <span class="material-symbols-outlined community-theme-option-icon" aria-hidden="true" data-sr-material-icon><?php echo sr_e((string) ($layoutColorSchemeIcons[$layoutColorSchemeKey] ?? 'light_mode')); ?></span>
