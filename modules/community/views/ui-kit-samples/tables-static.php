            ...
            <form class="filtering filtering-plain" action="#" method="get">
                <div class="filtering-fields">
                    ...
                    <label class="filtering-field-fill" for="admin_ui_filtering_plain_keyword">
                        ...
                        <input id="admin_ui_filtering_plain_keyword" type="text" class="form-input" name="q" placeholder="제목, Slug">
                    </label>
                </div>
            ...
            <form class="filtering filtering-card" action="#" method="get" data-filtering>
                <div class="filtering-fields">
                    ...
                    <label class="filtering-field-fill" for="admin_ui_filtering_card_keyword">
                        <span class="form-label">검색어</span>
                        <input id="admin_ui_filtering_card_keyword" type="text" class="form-input" name="q" placeholder="제목, Slug">
                    </label>
                </div>
                <div id="admin_ui_filtering_card_detail" class="filtering-body" data-filtering-body hidden>
                    <div class="filtering-field">
                        <span class="form-label">분류</span>
                        <div id="community_ui_filtering_card_category" class="filtering-toggle-group filtering-radio-toggle-group" data-filtering-radio-toggle-group>
                            <span class="filtering-toggle-item">
                                <input id="community_ui_filtering_card_category_all" type="radio" name="category" value="" class="form-choice-toggle-input sr-only" data-filtering-radio-toggle-choice checked>
                                <label for="community_ui_filtering_card_category_all" class="btn btn-choice-light btn-group-start">전체</label>
                            </span>
                            <span class="filtering-toggle-item">
                                <input id="community_ui_filtering_card_category_notice" type="radio" name="category" value="공지" class="form-choice-toggle-input sr-only" data-filtering-radio-toggle-choice>
                                <label for="community_ui_filtering_card_category_notice" class="btn btn-choice-light btn-group-middle">공지</label>
                            </span>
                            <span class="filtering-toggle-item">
                                <input id="community_ui_filtering_card_category_guide" type="radio" name="category" value="가이드" class="form-choice-toggle-input sr-only" data-filtering-radio-toggle-choice>
                                <label for="community_ui_filtering_card_category_guide" class="btn btn-choice-light btn-group-end">가이드</label>
                            </span>
                        </div>
                    </div>
