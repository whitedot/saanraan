                            ...
                            <div class="card-body">
                                <div class="ui-kit-stack-4">
                                    <div class="alert alert-primary alert-link-line"
                                        ...
                                        <a href="#" class="sample-strong-link"><?php echo sr_e(sr_t('ui.text.5c2efd36')); ?></a>
                                    ...
                                    <div class="alert alert-secondary alert-link-line"
                                        ...
                                        <a href="#" class="sample-strong-link"><?php echo sr_e(sr_t('ui.text.3823379a')); ?></a>
                                    ...
                                    <div class="alert alert-success alert-link-line"
                                        ...
                                        <a href="#" class="sample-strong-link"><?php echo sr_e(sr_t('ui.text.a0eef836')); ?></a>
                                    </div>

                                    <div class="alert alert-danger alert-link-line"
                                        role="alert">
                                        <?php echo sr_e(sr_t('ui.text.b15c56a2')); ?>
                                        <a href="#" class="sample-strong-link"><?php echo sr_e(sr_t('ui.notification.e3884fc0')); ?></a>
                                    ...
                                    <div class="alert alert-info alert-link-line"
                                        ...
                                        <a href="#" class="sample-strong-link"><?php echo sr_e(sr_t('ui.text.e33399f2')); ?></a>
                                    ...
                                    <div class="alert alert-solid alert-light alert-link-line"
                                        ...
                                        <a href="#" class="sample-strong-link"><?php echo sr_e(sr_t('ui.text.5a7e51f7')); ?></a>
                                    ...
                                    <div class="alert alert-dark alert-link-line"
                                        ...
                                        <a href="#" class="sample-strong-link"><?php echo sr_e(sr_t('ui.text.40950d5b')); ?></a>
                            ...
                            <div class="card-body">
                                <div class="ui-kit-stack-4">
                                    <div class="alert alert-success alert-block ui-kit-pad-6" role="alert">
                                        <h4 class="sample-success-text ui-kit-space-after-2 sample-heading-size sample-emphasis"><?php echo sr_e(sr_t('ui.text.9e47abeb')); ?></h4>
                                    ...
                                    <div class="alert alert-secondary ui-kit-gap-3 ui-kit-pad-6" role="alert">
                                        ...
                                        <div>
                                            <h4 class="sample-secondary-accent ui-kit-space-after-2 sample-heading-size sample-emphasis"><?php echo sr_e(sr_t('ui.text.812eeb2e')); ?></h4>
                                    ...
                                    <div class="alert alert-danger ui-kit-gap-3 ui-kit-pad-6" role="alert">
                                        ...
                                        <div>
                                            <h4 class="validation-danger-label ui-kit-space-after-2 sample-heading-size sample-emphasis"><?php echo sr_e(sr_t('ui.notification.2526ab43')); ?></h4>
                                ...
                                <div class="ui-kit-stack-4">
                                    ...
                                    <div class="alert alert-light ui-kit-gap-base sample-frame-strong ui-kit-pad-6"
                                        ...
                                        <div class="sample-muted">
                                            <h4 class="sample-muted ui-kit-space-after-2 sample-heading-size sample-emphasis"><?php echo sr_e(sr_t('ui.text.9f4b63f6')); ?></h4>
