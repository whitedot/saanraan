                    ...
                    <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-md-3 ui-kit-gap-base">
                        ...
                        <div class="card">
                            <div class="ui-kit-grid ui-kit-grid-1 ui-kit-align-items-center ui-kit-grid-md-3">
                                <div>
                                    <img src="<?php echo sr_e(sr_url('/assets/ui-kit-sample-card.jpg')); ?>" class="sample-card-media-start-radius community-sample-card-media-fill" alt="<?php echo sr_e(sr_t('admin::ui.text.af51d6de')); ?>" />
                                </div>
                        ...
                        <div class="card">
                            <div class="ui-kit-grid ui-kit-grid-1 ui-kit-align-items-center ui-kit-grid-md-3">
                                ...
                                <div>
                                    <img src="<?php echo sr_e(sr_url('/assets/ui-kit-sample-card.jpg')); ?>" class="sample-card-media-end-radius community-sample-card-media-fill" alt="<?php echo sr_e(sr_t('admin::ui.text.af51d6de')); ?>" />
                                </div>
                            </div>
                        </div>
                                </div>
                        ...
                        <div class="card ui-kit-group">
                            <a href="#">
                                <img src="<?php echo sr_e(sr_url('/assets/ui-kit-sample-card.jpg')); ?>" class="sample-card-media-top-radius community-sample-card-media-top" alt="<?php echo sr_e(sr_t('admin::ui.text.af51d6de')); ?>" />
                            </a>
                            <div class="card-body">
                                <a href="#">
                        ...
                        <div class="card ui-kit-fill-height sample-radius-md-s-sm sample-radius-md-e-none">
                            <img class="card-img-top community-sample-card-media-top" src="<?php echo sr_e(sr_url('/assets/ui-kit-sample-card.jpg')); ?>" alt="<?php echo sr_e(sr_t('admin::ui.text.af51d6de')); ?>" />
                            <div class="card-body">
