            ...
            <div class="filtering filtering-card<?php echo $policySetDetailFilterOpen ? ' filtering-open' : ''; ?>" data-filtering>
                <div class="filtering-fields">
                    ...
                    <div class="filtering-field-fill filtering-field admin-community-asset-policy-set-filter-keyword">
                        ...
                        <input id="community_policy_set_filter_q" type="text" name="q" value="<?php echo sr_e((string) ($policySetFilters['q'] ?? '')); ?>" class="form-input filtering-input" maxlength="120" placeholder="관리용 키 또는 이름">
                    </div>
                </div>
            ...
            <table class="table table-list">
                ...
                <thead>
                    <tr>
                        ...
                        <th<?php echo sr_admin_sort_aria('set_key', $policySetSort); ?>><?php echo sr_admin_sort_header_html('관리용 키', 'set_key', $policySetSort, sr_community_asset_policy_set_sort_options(), sr_community_asset_policy_set_default_sort()); ?></th>
...
<?php } else { ?>
    <form method="post" action="<?php echo sr_e(sr_url('/admin/community/asset-policy-sets')); ?>" class="admin-form ui-form-theme" data-sr-validate-form>
        ...
        <section class="card">
            ...
            <div class="form-row">
                <label class="form-label" for="community_policy_set_key">관리용 키 <span class="sr-required-label">(필수)</span></label>
