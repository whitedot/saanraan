        ...
        <tbody>
            ...
            <?php foreach ($boards as $board) { ?>
                <tr>
                    ...
                    <td><?php echo toy_e((string) $board['read_policy']); ?></td>
                    <td><?php echo toy_e((string) $board['write_policy']); ?></td>
                    <td><?php echo toy_e((string) $board['comment_policy']); ?></td>
                    <td><?php echo toy_e((string) $board['sort_order']); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
