...
<?php if ($communityBoardGroupsPage === 'list') { ?>
    ...
    <section class="admin-card admin-list-card card admin-list-form">
        <div class="card-header">
            ...
            <a href="<?php echo sr_e(sr_url('/admin/community/board-groups/new')); ?>" class="btn btn-sm btn-solid-light"><?php echo sr_e(sr_t('community::ui.text.1f051912')); ?></a>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="admin-table-actions-cell">
                            <div class="admin-row-actions">
                                <a href="<?php echo sr_e(sr_url('/admin/community/board-groups/edit?id=' . rawurlencode((string) $boardGroup['id']))); ?>" class="btn btn-sm btn-solid-light"><?php echo sr_e(sr_t('community::ui.edit.3537f0cc')); ?></a>
                            </div>
                        </td>
                    </tr>
                <?php } ?>
    ...
    <form method="post" action="<?php echo sr_e(sr_url($communityBoardGroupsPage === 'edit' ? '/admin/community/board-groups/update' : '/admin/community/board-groups/create')); ?>" class="admin-form ui-form-theme">
        ...
        <section class="admin-card card">
            <h2><?php echo sr_e(sr_t('community::ui.settings.021ed27a')); ?></h2>
                ...
                <div class="admin-form-row">
                    <label class="form-label" for="community_admin_board_groups_group_read_group_keys"><?php echo sr_e(sr_t('community::ui.member.ecf858a4')); ?></label>
                    <div class="admin-form-field">
                ...
                <div class="admin-form-row">
                    <label class="form-label" for="community_admin_board_groups_group_write_group_keys"><?php echo sr_e(sr_t('community::ui.member.e99a3ed2')); ?></label>
                    <div class="admin-form-field">
                ...
                <div class="admin-form-row">
                    <label class="form-label" for="community_admin_board_groups_group_comment_group_keys"><?php echo sr_e(sr_t('community::ui.member.11859d69')); ?></label>
                    <div class="admin-form-field">
                ...
                <div class="admin-form-row">
                    <label class="form-label" for="community_admin_board_groups_group_file_allowed_extensions"><?php echo sr_e(sr_t('community::ui.text.69600d46')); ?></label>
                    <div class="admin-form-field">
