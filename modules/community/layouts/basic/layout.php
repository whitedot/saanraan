                    ...
                    <details class="community-layout-member-menu">
                        ...
                        <div class="community-layout-member-dropdown" role="menu" aria-orientation="vertical">
                            <div class="community-layout-member-dropdown-header">
                                <span class="community-layout-member-avatar" aria-hidden="true"><?php echo sr_e($layoutMemberInitial); ?></span>
                                ...
                                <span class="community-layout-member-badge"><?php echo sr_e('회원'); ?></span>
                            </div>
