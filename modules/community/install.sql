...
CREATE TABLE IF NOT EXISTS sr_community_board_field_definitions (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    board_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS sr_community_posts (
    ...
    KEY idx_sr_community_posts_summary_status_id (summary_feed_candidate, status, id),
    KEY idx_sr_community_posts_summary_status_view_id (summary_feed_candidate, status, view_count, id)
);
...
CREATE TABLE IF NOT EXISTS sr_community_post_field_values (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    post_id BIGINT UNSIGNED NOT NULL,
    field_key VARCHAR(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS sr_community_level_recalculate_jobs (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    requested_by BIGINT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS sr_community_post_read_payment_logs (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    board_id BIGINT UNSIGNED NOT NULL DEFAULT 0,
    post_id BIGINT UNSIGNED NOT NULL,
    post_title_snapshot VARCHAR(160) NOT NULL DEFAULT '',
