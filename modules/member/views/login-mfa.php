            ...
            <div class="card-body member-skin-basic-stack">
                ...
                <form method="post" action="<?php echo sr_e(sr_url('/login/mfa')); ?>" class="member-skin-basic-form" data-sr-validate-form>
                    ...
                    <div class="member-skin-basic-field">
                        <label class="form-label" for="modules_member_login_mfa_code"><?php echo sr_e(sr_t('member::ui.login_mfa.code')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('member::ui.required.1f227c67')); ?></span></label>
                        <input id="modules_member_login_mfa_code" type="text" name="code" value="" inputmode="numeric" autocomplete="one-time-code" required class="form-input">
                    </div>
