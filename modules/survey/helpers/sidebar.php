...
{
    $cachedPayload = sr_public_data_cache_read('public-side-menu', 'survey.groups', 'survey_sidebar_groups_v1');
    ...
    sr_public_data_cache_write('public-side-menu', 'survey.groups', 'survey_sidebar_groups_v1', $groups);
