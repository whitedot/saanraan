...
sr_admin_require_permission($pdo, (int) $account['id'], '/admin/surveys/notification-templates', 'view');
if (sr_request_method() === 'POST') {
    sr_require_csrf();
    sr_admin_require_permission($pdo, (int) $account['id'], '/admin/surveys/notification-templates', 'edit');
}

sr_notification_event_template_admin_handle($pdo, $site ?? null, [
    'module_key' => 'survey',
    'permission_path' => '/admin/surveys/notification-templates',
    'return_path' => '/admin/surveys/notification-templates',
    'title' => '설문 알림/메일 관리',
]);
