...
if (sr_request_method() === 'POST') {
    ...
    sr_redirect('/admin/surveys/comments?' . http_build_query(sr_survey_admin_comment_filters_from_request()));
}
                    ...
                    <tr>
                        ...
                        <td class="admin-table-actions-cell text-end">
                            <?php if ($canEditComments) { ?>
                                <form method="post" action="<?php echo sr_e(sr_url('/admin/surveys/comments?' . http_build_query($commentFilters))); ?>" class="admin-row-actions">
