                ...
                <?php foreach ($comments as $comment) { ?>
                    ...
                    <tr>
                        ...
                        <td class="admin-table-break">
                            ...
                            <a href="<?php echo sr_e(sr_url('/survey/' . rawurlencode((string) ($comment['survey_key'] ?? '')) . '#survey-comments')); ?>" target="_blank" rel="noopener noreferrer">관리용 키: <?php echo sr_e((string) ($comment['survey_key'] ?? '')); ?></a>
                        </td>
                        <td class="admin-table-break">
