                                ...
                                <div>
                                    <nav class="tab-nav-bordered-tight" aria-label="Tabs" role="tablist"
                                        ...
                                        <button type="button"
                                            ...
                                            <div class="tabs-hidden-until-md"><?php echo sr_e(sr_t('ui.text.034999fa')); ?></div>
                                        </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <div class="tabs-hidden-until-md"><?php echo sr_e(sr_t('ui.text.4a784986')); ?></div>
                                        </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <div class="tabs-hidden-until-md"><?php echo sr_e(sr_t('ui.settings.115bced4')); ?></div>
                                        </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <div class="tabs-hidden-until-md"><?php echo sr_e(sr_t('ui.text.b8cf07ac')); ?></div>
                                        </button>
                                    </nav>
                                </div>
                            ...
                            <div class="card-header sample-border-dashed">
                                ...
                                <nav class="nav-tabs" aria-label="Tabs" role="tablist" data-tab-select="#tab-select">
                                    <button type="button"
                                        ...
                                        role="tab">
                                        <?php echo sr_material_icon_html('home', '', sr_t('ui.text.034999fa')); ?>
                                        <div class="tabs-hidden-until-md"><?php echo sr_e(sr_t('ui.text.50f30154')); ?></div>
                                    </button>
                                    ...
                                    <button type="button"
                                        ...
                                        <?php echo sr_material_icon_html('person', '', sr_t('ui.active.1ac6e422')); ?>
                                        <div class="tabs-hidden-until-md"><?php echo sr_e(sr_t('ui.text.b0b3d3bc')); ?></div>
                                    </button>
