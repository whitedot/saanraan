...
$surveyLayoutSettings = isset($surveyLayoutSettings) && is_array($surveyLayoutSettings)
    ? $surveyLayoutSettings
    : sr_survey_settings($pdo);

sr_public_layout_begin($pdo ?? null, $site ?? null, $seo, sr_survey_ui_kit_layout_context($surveyLayoutSettings, [
    'include_installed_layout_options' => true,
]));
?>

    <main class="example-survey-theme survey-ui-kit" data-example-theme-view="survey.ui-kit" data-theme-ui-kit-view="survey.sample">
