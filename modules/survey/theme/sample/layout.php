...
$layoutStylesheets = [];
$layoutScripts = ['/assets/common-ui.js', '/modules/survey/assets/layout.js'];
...
<body class="<?php echo sr_e(trim('survey-layout-body example-survey-layout-shell ' . $layoutBodyClass)); ?>" data-example-theme-layout="survey.sample">
    ...
    <header class="survey-layout-header" data-survey-scroll-header>
        ...
        <div class="survey-layout-actions">
            ...
            <?php if ($layoutMemberEnabled) { ?>
                    ...
                    <details class="survey-layout-member-menu">
                        ...
                        <div class="survey-layout-member-dropdown dropdown-menu-profile" role="menu" aria-orientation="vertical">
                            <div class="survey-layout-member-dropdown-header dropdown-profile-header">
                                <span class="survey-layout-member-avatar dropdown-profile-avatar <?php echo sr_e($layoutMemberAvatarColorClass); ?>" aria-hidden="true"><?php echo sr_e($layoutMemberInitial); ?></span>
                                <span class="survey-layout-member-identity dropdown-profile-identity">
                                ...
                                <span class="survey-layout-member-badge badge badge-pill <?php echo sr_e($layoutMemberBadgeClass); ?>"><?php echo sr_e($layoutMemberBadgeLabel); ?></span>
                            </div>
                            <a class="survey-layout-member-dropdown-link dropdown-profile-item" href="<?php echo sr_e(sr_url('/mypage')); ?>" role="menuitem">
                            ...
                            <?php if ($layoutCommunityMemberMenuEnabled) { ?>
                                <hr class="survey-layout-member-divider dropdown-profile-divider">
                                <a class="survey-layout-member-dropdown-link dropdown-profile-item" href="<?php echo sr_e(sr_url('/messages')); ?>" role="menuitem">
                                ...
                                <a class="survey-layout-member-dropdown-link dropdown-profile-item" href="<?php echo sr_e(sr_url('/community/scraps')); ?>" role="menuitem">
                            ...
                            <?php foreach ($layoutMemberAssetRows as $layoutMemberAssetRow) { ?>
                                ...
                                ?>
                                <a class="survey-layout-member-asset-row dropdown-profile-item" href="<?php echo sr_e((string) ($layoutMemberAssetRow['url'] ?? '#')); ?>" role="menuitem">
                            ...
                            <?php foreach ($layoutMemberActionRows as $layoutMemberActionRow) { ?>
                                <a class="survey-layout-member-action-row dropdown-profile-item" href="<?php echo sr_e((string) ($layoutMemberActionRow['url'] ?? '#')); ?>" role="menuitem">
                            ...
                            <form class="survey-layout-member-logout-form" method="post" action="<?php echo sr_e(sr_url('/logout')); ?>">
                                ...
                                <button class="survey-layout-member-logout-button dropdown-profile-item" type="submit" role="menuitem">
                ...
                <?php } else { ?>
                    <a class="survey-layout-icon-button survey-layout-member-link survey-layout-member-link-login" href="<?php echo sr_e(sr_member_login_url_for_current_request()); ?>" aria-label="<?php echo sr_e('로그인'); ?>">
    ...
    <footer class="survey-layout-footer">
        <div class="survey-layout-footer-row">
            ...
            <div class="survey-theme-dropdown dropdown" data-dropdown-placement="top-end">
                ...
                <div class="survey-theme-menu dropdown-menu" role="menu" aria-label="<?php echo sr_e('화면 모드'); ?>">
