...
<section class="card admin-list-card">
    ...
    <div class="card-description-block" aria-label="상태 설명">
        ...
        <dl class="card-description-list">
            <div>
                <dt>사용</dt>
                <dd>알림/메일 항목이 활성화되어 조건이 맞으면 알림 row 생성 또는 메일 발송 흐름을 실행합니다.</dd>
            </div>
            <div>
                <dt>사용(부분중지)</dt>
            ...
            <div>
                <dt>중지</dt>
                <dd>알림/메일 항목이 중지되어 알림 row, 메일 발송, 발송 작업을 만들지 않습니다.</dd>
            </div>
            <div>
                <dt>이메일 중지</dt>
                <dd>항목에 이메일이 선택되어 있지만 알림 모듈의 이메일 채널이 꺼져 있어 해당 채널의 발송 작업을 만들지 않습니다.</dd>
            </div>
            <div>
                <dt>외부채널 중지</dt>
                <dd>항목에 회원 외부채널이 선택되어 있지만 <a href="<?php echo sr_e($notificationTemplateExternalPushSettingsUrl); ?>" target="_blank" rel="noopener noreferrer">알림 모듈의 외부채널 수신 허용</a>이 꺼져 있어 해당 채널의 발송 작업을 만들지 않습니다.</dd>
            </div>
        </dl>
    </div>
</section>
