...
<form method="post" action="<?php echo sr_e(sr_url('/admin/notifications/settings')); ?>" class="admin-form ui-form-theme">
    ...
    <section class="admin-card card">
        ...
        <div class="admin-form-row">
            ...
            <div class="admin-form-field">
                <label class="admin-form-check form-label" for="notification_admin_settings_email_channel_enabled">
                    <input id="notification_admin_settings_email_channel_enabled" type="checkbox" name="email_channel_enabled" value="1" class="form-checkbox"<?php echo !empty($settings['email_channel_enabled']) ? ' checked' : ''; ?>>
        ...
        <div class="admin-form-row">
            ...
            <div class="admin-form-field">
                <select id="notification_admin_settings_email_transport" name="email_transport" class="form-select">
        ...
        <div class="admin-form-row">
            <label class="form-label" for="notification_admin_settings_email_from_email">발신 이메일</label>
            <div class="admin-form-field">
                <input id="notification_admin_settings_email_from_email" type="email" name="email_from_email" value="<?php echo sr_e((string) $settings['email_from_email']); ?>" maxlength="255" class="form-input form-control-full" autocomplete="email">
        ...
        <div class="admin-form-row">
            ...
            <div class="admin-form-field">
                <input id="notification_admin_settings_email_timeout_seconds" type="number" name="email_timeout_seconds" value="<?php echo sr_e((string) $settings['email_timeout_seconds']); ?>" min="3" max="30" class="form-input">
    ...
    <section class="admin-card card">
        <h2>SMTP</h2>
        <div class="admin-form-row">
            <label class="form-label" for="notification_admin_settings_email_smtp_host">호스트</label>
            <div class="admin-form-field">
                <input id="notification_admin_settings_email_smtp_host" type="text" name="email_smtp_host" value="<?php echo sr_e((string) $settings['email_smtp_host']); ?>" maxlength="255" class="form-input form-control-full" autocomplete="off">
            </div>
        </div>
        <div class="admin-form-row">
            <label class="form-label" for="notification_admin_settings_email_smtp_port">포트 <span class="sr-required-label">(필수)</span></label>
            <div class="admin-form-field">
                <input id="notification_admin_settings_email_smtp_port" type="number" name="email_smtp_port" value="<?php echo sr_e((string) $settings['email_smtp_port']); ?>" min="1" max="65535" class="form-input">
            </div>
        </div>
        <div class="admin-form-row">
            ...
            <div class="admin-form-field">
                <select id="notification_admin_settings_email_smtp_encryption" name="email_smtp_encryption" class="form-select">
    ...
    <section class="admin-card card">
        <h2>메일 HTTP API</h2>
        <div class="admin-form-row">
            <label class="form-label" for="notification_admin_settings_email_http_api_endpoint">Endpoint</label>
            <div class="admin-form-field">
                <input id="notification_admin_settings_email_http_api_endpoint" type="url" name="email_http_api_endpoint" value="<?php echo sr_e((string) $settings['email_http_api_endpoint']); ?>" maxlength="255" class="form-input form-control-full" placeholder="https://api.example.com/mail/send">
