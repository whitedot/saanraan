                ...
                <?php foreach ($comments as $comment) { ?>
                    ...
                    <tr>
                        ...
                        <td class="admin-table-break">
                            <strong><a href="<?php echo sr_e(sr_url('/quiz/' . rawurlencode((string) ($comment['quiz_key'] ?? '')) . '?result=1#quiz-comments')); ?>" target="_blank" rel="noopener noreferrer"><?php echo sr_e((string) ($comment['quiz_title'] ?? '')); ?></a></strong><br>
                            <a href="<?php echo sr_e(sr_url('/quiz/' . rawurlencode((string) ($comment['quiz_key'] ?? '')) . '?result=1#quiz-comments')); ?>" target="_blank" rel="noopener noreferrer">(<?php echo sr_e((string) ($comment['quiz_key'] ?? '')); ?>)</a>
                        </td>
                        <td class="admin-table-break">
                        ...
                        <td class="admin-table-nowrap"><span class="badge-status <?php echo sr_e(sr_quiz_admin_status_class($currentStatus)); ?>"><?php echo sr_e(sr_quiz_comment_status_label($currentStatus)); ?></span></td>
