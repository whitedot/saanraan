                ...
                <?php foreach ($attempts as $attempt) { ?>
                    ...
                    <tr>
                        ...
                        <td class="admin-table-break">
                            ...
                            <span class="admin-summary-meta">(<?php echo sr_e((string) ($attempt['quiz_key'] ?? '')); ?>) · 시도 #<?php echo sr_e((string) (int) ($attempt['id'] ?? 0)); ?></span>
                        ...
                        <td class="admin-table-break">
                            <?php if ((string) ($attempt['result_title'] ?? '') !== '') { ?>
                                ...
                                <?php if ((string) ($attempt['result_key'] ?? '') !== '') { ?>
                                    <br><span class="admin-summary-meta">(<?php echo sr_e((string) ($attempt['result_key'] ?? '')); ?>)</span>
                                <?php } ?>
