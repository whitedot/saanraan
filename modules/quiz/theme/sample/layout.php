...
$layoutBusinessInfoHtml = $layoutBusinessInfoVisible ? sr_site_business_info_html($layoutPdo, 'quiz-layout') : '';
...
<body class="<?php echo sr_e(trim('quiz-layout-body example-quiz-layout-shell ' . $layoutBodyClass)); ?>" data-example-theme-layout="quiz.sample">
    ...
    <header class="quiz-layout-header" data-quiz-scroll-header>
        ...
        <div class="quiz-layout-actions">
            ...
            <?php if ($layoutMemberEnabled) { ?>
                    ...
                    <details class="quiz-layout-member-menu">
                        ...
                        <div class="quiz-layout-member-dropdown dropdown-menu-profile" role="menu" aria-orientation="vertical">
                            ...
                            <?php if ($layoutCommunityMemberMenuEnabled) { ?>
                                ...
                                <a class="quiz-layout-member-dropdown-link dropdown-profile-item" href="<?php echo sr_e(sr_url('/messages')); ?>" role="menuitem">
                ...
                <?php } else { ?>
                    <a class="quiz-layout-icon-button quiz-layout-member-link quiz-layout-member-link-login" href="<?php echo sr_e(sr_member_login_url_for_current_request()); ?>" aria-label="<?php echo sr_e('로그인'); ?>">
