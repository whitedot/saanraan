                                ...
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-lg-2 ui-kit-gap-base">
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="simpleinput" class="form-label"><?php echo sr_e(sr_t('ui.simple.input.cb0b2f70')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.floating.input.cba11e12')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="validInput" class="form-label"><?php echo sr_e(sr_t('ui.valid.input.da64ada7')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-rounded" class="form-label"><?php echo sr_e(sr_t('ui.rounded.input.f0ad333f')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-textarea" class="form-label"><?php echo sr_e(sr_t('ui.text.area.2dbabf8d')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-disable" class="form-label"><?php echo sr_e(sr_t('ui.disabled.54612c16')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-helping" class="form-label"><?php echo sr_e(sr_t('ui.helping.text.e77e662a')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="discount" class="form-label"><?php echo sr_e(sr_t('ui.select.select.with.icon.623ff179')); ?></label>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.label.input.5bde99cc')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="SearchInput" class="form-label"><?php echo sr_e(sr_t('ui.search.search.style.ca458659')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="inValidationInput" class="form-label"><?php echo sr_e(sr_t('ui.invalid.input.97005652')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-placeholder" class="form-label"><?php echo sr_e(sr_t('ui.placeholder.37969de3')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-readonly" class="form-label"><?php echo sr_e(sr_t('ui.readonly.664fd112')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-static" class="form-label"><?php echo sr_e(sr_t('ui.static.control.e9099e05')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.select.default.select.861b0eab')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <span class="form-label"><?php echo sr_e(sr_t('ui.list.checkbox.list.d31f7ae8')); ?></span>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-lg-2 ui-kit-gap-base">
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-email" class="form-label"><?php echo sr_e(sr_t('ui.email.email.8b8a829e')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="password" class="form-label"><?php echo sr_e(sr_t('ui.password.show.hide.password.bffe9d7a')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-time" class="form-label"><?php echo sr_e(sr_t('ui.time.a85f0011')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-number" class="form-label"><?php echo sr_e(sr_t('ui.number.7e569561')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-range" class="form-label"><?php echo sr_e(sr_t('ui.range.c39250e4')); ?></label>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-password" class="form-label"><?php echo sr_e(sr_t('ui.password.password.22c84385')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-month" class="form-label"><?php echo sr_e(sr_t('ui.month.b274c0c9')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-week" class="form-label"><?php echo sr_e(sr_t('ui.week.aab53b22')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="example-color" class="form-label"><?php echo sr_e(sr_t('ui.color.aa8ae7a1')); ?></label>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-lg-2 ui-kit-gap-base">
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.active.name.username.b19d3d5e')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.amount.f78975a2')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.textarea.9cbf1bae')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.input.button.f4339c75')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="formFileMultiple01" class="form-label"><?php echo sr_e(sr_t('ui.multiple.files.48167df8')); ?></label>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.recipient.2c64ddc4')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.email.login.email.login.62fef2c1')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.url.vanity.url.3e033a6a')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="inputGroupFile04" class="form-label"><?php echo sr_e(sr_t('ui.file.input.c956dabe')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.select.input.group.select.ab4404f1')); ?></label>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-lg-2 ui-kit-gap-base">
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.email.e9abda44')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.comments.8eea4e12')); ?></label>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.password.4fa210a0')); ?></label>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-lg-2 ui-kit-gap-base">
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="input-small" class="form-label"><?php echo sr_e(sr_t('ui.small.32265979')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="input-large" class="form-label"><?php echo sr_e(sr_t('ui.large.865b14fe')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.select.menu.9633940e')); ?></label>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="input-normal" class="form-label"><?php echo sr_e(sr_t('ui.normal.339d3ab4')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label for="input-gridsize" class="form-label"><?php echo sr_e(sr_t('ui.grid.sizes.dcc4d2ee')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.select.menu.c84a7b65')); ?></label>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-lg-2 ui-kit-gap-base">
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.checkboxes.3f234b18')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.switches.86b5bc92')); ?></label>
                                            </div>
                                            ...
                                            <div class="ui-kit-stack-3 ui-kit-column-lg-2">
                                                ...
                                                <div class="ui-kit-cluster ui-kit-align-items-center ui-kit-gap-2">
                                                    ...
                                                    <label for="switch2" class="ui-kit-hint"><?php echo sr_e(sr_t('ui.text.b9af9dc0')); ?></label>
                                                </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.text.1855fe4d')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.text.1942c077')); ?></label>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.radios.a8e1ef53')); ?></label>
                                            </div>
                                            ...
                                            <div class="ui-kit-stack-3 ui-kit-column-lg-2">
                                                ...
                                                <div class="ui-kit-cluster ui-kit-align-items-center ui-kit-gap-2">
                                                    <input type="radio" name="disabledRadioOptions" id="inlineRadio3"
                                                        ...
                                                        disabled />
                                                    <label for="inlineRadio3" class="ui-kit-hint"><?php echo sr_e(sr_t('ui.status.457b2a9e')); ?></label>
                                                </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.reverse.dfe78742')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.text.a133349e')); ?></label>
                                            </div>
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.checkbox.toggle.50291b0c')); ?></label>
                                            </div>

                                            <div class="ui-kit-stack-3 ui-kit-column-lg-2">
                                                <!-- Single Toggle -->
                                                <div>
                                                    <input type="checkbox" id="toggleSingle" class="form-choice-toggle-input ui-kit-hidden" />
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label">체크박스 토글 색상</label>
                                            </div>
                                            ...
                                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2 ui-kit-column-lg-2">
                                                <?php foreach (['primary' => 'Primary', 'secondary' => 'Secondary', 'success' => 'Success', 'info' => 'Info', 'warning' => 'Warning', 'danger' => 'Danger', 'dark' => 'Dark', 'light' => 'Light'] as $choiceColor => $choiceLabel) { ?>
                                                    <div>
                                                        <input type="checkbox" id="toggleColor<?php echo sr_e(ucfirst($choiceColor)); ?>" class="form-choice-toggle-input ui-kit-hidden" checked />
                                        ...
                                        <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-1-5 ui-kit-grid-lg-3 ui-kit-gap-lg-9">
                                            <div>
                                                <label class="form-label"><?php echo sr_e(sr_t('ui.radio.toggle.1512d5a1')); ?></label>
                                            </div>
