...
<div class="container-fluid">
                    <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-base">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-hint ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.text.7e7bb680')); ?></p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="ui-kit-hint ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.page.354cddad')); ?></p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="ui-kit-hint ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.active.623f1f1c')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                <!-- Modal Heading -->
                                <div>
                                    <button type="button"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="ui-kit-hint ui-kit-space-after-4"><code>data-overlay</code> <?php echo sr_e(sr_t('ui.text.1f4997e4')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                <div>
                                    <button type="button"
                                        class="btn btn-solid-secondary"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="ui-kit-hint ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.active.all.07d37118')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                <!-- Full Screen Modal -->
                                <div>
                                    <button type="button"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="ui-kit-hint ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.static.settings.4d8a4647')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
