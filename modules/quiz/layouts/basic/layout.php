...
<body class="<?php echo sr_e(trim('quiz-layout-body ' . $layoutBodyClass)); ?>">
    <header class="quiz-layout-header">
        <a class="quiz-layout-brand-link" href="<?php echo sr_e($layoutBrandLinkUrl); ?>">
            ...
            <?php } else { ?>
                <span class="quiz-layout-brand-text"><?php echo sr_e($layoutSiteName !== '' ? $layoutSiteName : 'Saanraan'); ?></span>
            <?php } ?>
        </a>
        ...
        <div class="quiz-layout-actions">
                            ...
                            <div class="quiz-layout-notification-list">
                                <?php foreach ($layoutNotificationSummary['items'] as $layoutNotification) { ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php } ?>
                                        <span class="quiz-layout-notification-date"><?php echo sr_e((string) ($layoutNotification['created_at'] ?? '')); ?></span>
                                    <?php if ($layoutNotificationLinkAttributes !== '') { ?>
                                        </a>
                                    <?php } else { ?>
                                        </div>
            ...
            <?php } ?>
            <a class="quiz-layout-icon-button" href="<?php echo sr_e(sr_url('/account')); ?>" aria-label="<?php echo sr_e('회원'); ?>">
