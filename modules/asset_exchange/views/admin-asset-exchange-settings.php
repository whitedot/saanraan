...
$settingsHelpId = 'asset-exchange-settings-common-help-modal';
$settingsHelpBody = '<p>이 화면의 값은 자산별 기준값에서 파생되는 모든 환전 방향에 공통으로 적용됩니다.</p>'
    . '<p>환전 비율은 포인트/적립금/예치금 기준값 화면에서만 설정하고, 이 화면에서는 상태, 제한, 반올림, 수수료 조건을 관리합니다.</p>';
...
$settingsHelp = [
    'status' => [
        ...
        'body_html' => $settingsHelpBodyHtml([
            '사용 상태이면 기준값에서 파생된 환전 방향이 회원 화면에 노출될 수 있습니다.',
            '중지 상태이면 기준값과 공통 조건은 저장하지만 신규 환전 실행은 막습니다.',
        ]),
    ],
    'rounding' => [
        ...
        'title' => '공통 반올림',
        'body_html' => $settingsHelpBodyHtml([
            '자산별 기준값으로 계산한 환전 결과가 정수가 아닐 때 사용할 처리 방식입니다.',
    ...
    'amount_limit' => [
        ...
        'title' => '공통 환전량 제한',
        'body_html' => $settingsHelpBodyHtml([
            '모든 환전 방향에 적용되는 출금 항목 기준 최소/최대 환전량입니다.',
            '최대 환전량을 비워두면 1회 최대 금액 제한을 두지 않습니다.',
        ]),
    ],
    'fee_trigger' => [
        ...
        'title' => '공통 수수료 적용',
        'body_html' => $settingsHelpBodyHtml([
            '파생 환전 방향에 수수료를 적용할지 정합니다.',
            '사용 안 함이면 수수료 관련 입력은 숨겨지고 저장값도 비워진 상태로 반영됩니다.',
            '환금성 항목 재환전만 적용은 회원이 환금성 항목을 다시 다른 항목으로 환전하는 경우를 수수료 대상으로 둡니다.',
        ]),
    ],
    'fee_basis' => [
        ...
        'title' => '공통 수수료 기준',
        'body_html' => $settingsHelpBodyHtml([
            '정률 수수료를 쓸 때 퍼센트를 어느 금액에 적용할지 정합니다.',
    ...
    'fee_type' => [
        ...
        'title' => '공통 수수료 방식',
        'body_html' => $settingsHelpBodyHtml([
            '정률 또는 정액 중 어느 수수료 방식을 적용할지 정합니다.',
    ...
    'sort_order' => [
        ...
        'title' => '공통 정렬순서',
        'body_html' => $settingsHelpBodyHtml([
            '파생 환전 방향 목록의 기준 정렬순서입니다.',
            '숫자가 작을수록 회원 환전 신청 화면과 관리자 환전표에서 먼저 표시됩니다.',
        ]),
    ],
];
...
<form method="post" action="<?php echo sr_e(sr_url('/admin/asset-exchange/settings')); ?>" class="admin-form ui-form-theme" data-asset-exchange-settings-form>
    ...
    <section class="card">
        <div class="card-header">
            <h2 class="card-title">공통 환전 조건</h2>
            <div class="card-actions">
                <button type="button" class="btn btn-icon-xs btn-ghost-default admin-label-help-button" aria-label="공통 환전 조건 도움말" aria-haspopup="dialog" aria-expanded="false" aria-controls="<?php echo sr_e($settingsHelpId); ?>" data-overlay="#<?php echo sr_e($settingsHelpId); ?>">
                    <?php echo sr_material_icon_html('help'); ?>
                </button>
            </div>
        </div>
        <div class="form-row">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_status', '상태', $settingsHelp['status']['id'], $settingsHelpOpenLabel, true); ?>
        ...
        <div class="form-row">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_rounding_mode', '반올림', $settingsHelp['rounding']['id'], $settingsHelpOpenLabel, true); ?>
            <div class="form-field">
        ...
        <div class="form-row">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_min_amount', '최소 환전량', $settingsHelp['amount_limit']['id'], $settingsHelpOpenLabel, true); ?>
            <div class="form-field">
        ...
        <div class="form-row">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_max_amount', '최대 환전량', $settingsHelp['amount_limit']['id'], $settingsHelpOpenLabel); ?>
            <div class="form-field">
        ...
        <div class="form-row">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_fee_trigger', '수수료 적용', $settingsHelp['fee_trigger']['id'], $settingsHelpOpenLabel, true); ?>
            <div class="form-field">
        ...
        <div class="form-row" data-asset-exchange-settings-fee-row data-asset-exchange-settings-fee-type="rate">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_fee_basis', '수수료 기준', $settingsHelp['fee_basis']['id'], $settingsHelpOpenLabel, true); ?>
            <div class="form-field">
        ...
        <div class="form-row" data-asset-exchange-settings-fee-row>
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_fee_type', '수수료 방식', $settingsHelp['fee_type']['id'], $settingsHelpOpenLabel, true); ?>
            <div class="form-field">
        ...
        <div class="form-row" data-asset-exchange-settings-fee-row data-asset-exchange-settings-fee-type="rate">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_fee_rate_numerator', '정률 수수료', $settingsHelp['fee_amount']['id'], $settingsHelpOpenLabel, true); ?>
            <div class="form-field">
        ...
        <div class="form-row" data-asset-exchange-settings-fee-row data-asset-exchange-settings-fee-type="fixed">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_fee_fixed_amount', '정액 수수료', $settingsHelp['fee_amount']['id'], $settingsHelpOpenLabel, true); ?>
            <div class="form-field">
        ...
        <div class="form-row" data-asset-exchange-settings-fee-row>
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_fee_min_amount', '최소 수수료', $settingsHelp['fee_amount']['id'], $settingsHelpOpenLabel); ?>
            <div class="form-field">
        ...
        <div class="form-row" data-asset-exchange-settings-fee-row>
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_fee_max_amount', '최대 수수료', $settingsHelp['fee_amount']['id'], $settingsHelpOpenLabel); ?>
            <div class="form-field">
        ...
        <div class="form-row">
            <?php echo sr_admin_form_label_help_html('asset_exchange_settings_policy_default_sort_order', '정렬순서', $settingsHelp['sort_order']['id'], $settingsHelpOpenLabel); ?>
            <div class="form-field">
...
<?php echo sr_admin_help_modal_html($settingsHelpId, '공통 환전 조건', $settingsHelpBody); ?>
