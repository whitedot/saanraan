...
return [
    'GET /admin/policy-documents' => 'actions/admin-policy-documents.php',
    'POST /admin/policy-documents' => 'actions/admin-policy-documents.php',
    'GET /admin/policy-documents/document-new' => 'actions/admin-policy-document-document-new.php',
