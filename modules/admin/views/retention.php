...
<form method="post" action="<?php echo sr_e(sr_url('/admin/retention')); ?>" class="admin-form ui-form-theme">
    ...
    <section class="admin-card admin-list-card card">
        ...
        <div class="admin-form-row">
            <label class="form-label" for="admin_retention_auth_logs_days">인증 로그 보관일 <span class="sr-required-label">(필수)</span></label>
        ...
        <div class="admin-form-row">
            <label class="form-label" for="admin_retention_audit_logs_days">관리자 작업 로그 보관일 <span class="sr-required-label">(필수)</span></label>
            <div class="admin-form-field">
        ...
        <div class="admin-form-row">
            <label class="form-label" for="admin_retention_used_tokens_days">사용 완료 토큰 보관일 <span class="sr-required-label">(필수)</span></label>
            <div class="admin-form-field">
        ...
        <div class="admin-form-row">
            <label class="form-label" for="admin_retention_sessions_days">만료/폐기 세션 보관일 <span class="sr-required-label">(필수)</span></label>
            <div class="admin-form-field">
        ...
        <?php if ($hasNotificationTables) { ?>
            <div class="admin-form-row">
                <label class="form-label" for="admin_retention_notifications_days">알림 보관일 <span class="sr-required-label">(필수)</span></label>
                <div class="admin-form-field">
        ...
        <?php } ?>
        <div class="admin-form-row">
            <label class="form-label" for="admin_retention_module_backups_days">모듈 백업 보관일 <span class="sr-required-label">(필수)</span></label>
            <div class="admin-form-field">
        ...
        <div class="admin-form-row">
            <label class="form-label" for="admin_retention_auto_cleanup_interval_hours">자동 정리 간격 <span class="sr-required-label">(필수)</span></label>
            <div class="admin-form-field">
        ...
        <div class="admin-form-row">
            <label class="form-label" for="admin_retention_auto_cleanup_batch_size">자동 정리 배치 크기 <span class="sr-required-label">(필수)</span></label>
            <div class="admin-form-field">
        ...
        <div class="modal-content">
            <form method="post" action="<?php echo sr_e(sr_url('/admin/retention')); ?>" class="admin-form ui-form-theme">
                ...
                <div class="modal-body">
                    ...
                    <div class="admin-form-row">
                        <span class="form-label">삭제 후보 확인 <span class="sr-required-label">(필수)</span></span>
                        <div class="admin-form-field">
                    ...
                    <div class="admin-form-row">
                        <label class="form-label" for="admin_retention_cleanup_phrase">확인 문구 <span class="sr-required-label">(필수)</span></label>
                        <div class="admin-form-field">
