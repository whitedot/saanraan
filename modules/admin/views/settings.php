    ...
    <div class="table-wrapper">
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td>기본 통화 변경</td>
                    <td><code><?php echo sr_e((string) $currencyChangeCurrentCurrency); ?></code></td>
                    <td class="admin-table-break">신규 가격/정책 row와 통화가 빠진 자산 구매력 계약의 fallback 기준만 바뀝니다. 기존 가격, 거래 로그, 구매력 snapshot은 변환하지 않습니다.</td>
...
<div id="admin-currency-change-modal" class="modal-overlay modal-overlay-fade overlay hidden pointer-events-none opacity-0" role="dialog" tabindex="-1" aria-labelledby="admin-currency-change-modal-title" aria-hidden="true" inert>
    <div class="modal-dialog modal-dialog-lg">
        <form method="post" action="<?php echo sr_e(sr_url('/admin/settings')); ?>" class="modal-content ui-form-theme" data-admin-currency-change-form data-current-currency="<?php echo sr_e((string) $currencyChangeCurrentCurrency); ?>">
            ...
            <div class="modal-body">
                ...
                <p class="admin-form-help">기본 통화는 신규 가격/정책 row와 통화가 빠진 자산 구매력 계약의 fallback 기준입니다. 기존 가격, 거래 로그, 구매력 snapshot은 변환하지 않습니다.</p>
                ...
                <?php } else { ?>
                    <p class="admin-form-help">현재 확인 가능한 가격/정산 통화 row가 없습니다. 그래도 이후 새 정책 기본값과 자산 구매력 fallback은 변경된 통화를 사용합니다.</p>
                <?php } ?>
                ...
                <div class="admin-form-row">
                    ...
                    <div class="admin-form-field">
                        <input id="admin_settings_currency_change_confirmation" type="text" name="currency_change_confirmation" class="form-input" maxlength="120" required autocomplete="off" data-admin-currency-change-confirmation>
                ...
                <div class="admin-form-row">
                    ...
                    <div class="admin-form-field">
                        <input id="admin_settings_currency_change_password" type="password" name="currency_change_password" class="form-input" autocomplete="current-password" required>
