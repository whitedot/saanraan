                                ...
                                <form id="customValidationForm" class="ui-kit-grid ui-kit-grid-md-12 ui-kit-grid-1 ui-kit-gap-base"
                                    ...
                                    <div class="ui-kit-column-md-4">
                                        ...
                                        <div class="ui-kit-position-context">
                                            ...
                                            <span class="ui-kit-icon-text valid-icon ui-kit-position-absolute ui-kit-position-top-half ui-kit-position-right-3 ui-kit-state-hidden ui-kit-center-y ui-kit-ink-success"><?php echo sr_e(sr_t('admin::ui.text.35688a85')); ?></span>
                                            <span class="ui-kit-icon-text invalid-icon ui-kit-position-absolute ui-kit-position-top-half ui-kit-position-right-3 ui-kit-state-hidden ui-kit-center-y ui-kit-ink-danger"><?php echo sr_e(sr_t('admin::ui.text.b49f20d8')); ?></span>
                                        </div>
                                    ...
                                    <div class="ui-kit-column-md-3">
                                        ...
                                        <div class="ui-kit-position-context">
                                            ...
                                            <span class="ui-kit-icon-text valid-icon ui-kit-position-absolute ui-kit-position-top-half ui-kit-position-right-9 ui-kit-state-hidden ui-kit-center-y ui-kit-ink-success"><?php echo sr_e(sr_t('admin::ui.text.35688a85')); ?></span>
                                            <span class="ui-kit-icon-text invalid-icon ui-kit-position-absolute ui-kit-position-top-half ui-kit-position-right-9 ui-kit-state-hidden ui-kit-center-y ui-kit-ink-danger"><?php echo sr_e(sr_t('admin::ui.text.b49f20d8')); ?></span>
                                        </div>
                                ...
                                <form id="serverForm" class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-md-12 ui-kit-gap-base" novalidate>
                                    ...
                                    <div class="ui-kit-column-md-4">
                                        ...
                                        <div class="ui-kit-position-context ui-kit-cluster ui-kit-radius-md">
                                            ...
                                            <div
                                                class="ui-kit-state-disabled-pointer ui-kit-position-absolute ui-kit-position-block-0 ui-kit-position-end-0 ui-kit-cluster ui-kit-align-items-center ui-kit-end-pad-3">
                                                <span class="ui-kit-icon-text ui-kit-ink-danger ui-kit-type-base"><?php echo sr_e(sr_t('admin::ui.text.b8cf07ac')); ?></span>
                                            </div>
                                        </div>
