                            ...
                            <div class="card-body">
                                <div class="table-wrapper">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.fdbfbd65')); ?></td>
                                            ...
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.933b33da')); ?></td>
                                            ...
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.e593251c')); ?></td>
                                            ...
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.5d0b5579')); ?></td>
                                            ...
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.f83d3085')); ?></td>
                                ...
                                <div class="table-wrapper">
                                    ...
                                    <thead class="sample-table-head-tinted">
                                        <tr>
                                            ...
                                            <th><?php echo sr_e(sr_t('admin::ui.text.f6b350f7')); ?></th>
                                            <th><?php echo sr_e(sr_t('admin::ui.status.e10195a1')); ?></th>
                                            <th class="sample-table-align-end"><?php echo sr_e(sr_t('admin::ui.text.01dfd369')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.f34403ae')); ?></td>
                                            ...
                                            <td class="sample-table-align-end">
                                                <div class="dropdown">
                                                    <button type="button"
                                                        ...
                                                        <?php echo sr_material_icon_html('more_horiz', '', sr_t('admin::ui.text.6e50bef7')); ?>
                                                    </button>
                                                    <div class="dropdown-menu" role="menu"
                                                        aria-orientation="vertical">
                                                        <a class="dropdown-item" href="#">
                                                            <?php echo sr_material_icon_html('visibility', '', sr_t('admin::ui.text.ac5b575f')); ?>
                                                        ...
                                                        <a class="dropdown-item dropdown-item-danger" href="#">
                                                            <?php echo sr_material_icon_html('delete', '', sr_t('admin::ui.delete.6139b6c3')); ?>
                                        ...
                                        <tr>
                                            <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.ddc3cc33')); ?></td>
                                            <td><?php echo sr_e(sr_t('admin::ui.text.4f972c4b')); ?></td>
                                            <td>$29.99</td>
                                            <td>150</td>
                                            <td>4.3 ★</td>
                                        ...
                                        <tr>
                                            <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.9e59e6ef')); ?></td>
                                            <td><?php echo sr_e(sr_t('admin::ui.text.a274b299')); ?></td>
                                            <td>$89.00</td>
                                            <td>60</td>
                                            <td>4.1 ★</td>
                                        ...
                                        <tr>
                                            <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.4k.86c66776')); ?></td>
                                            <td><?php echo sr_e(sr_t('admin::ui.text.3c34d590')); ?></td>
                                            <td>$349.00</td>
                                            <td>30</td>
                                            <td>4.8 ★</td>
                                        ...
                                        <tr>
                                            <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.9a13d293')); ?></td>
                                            <td><?php echo sr_e(sr_t('admin::ui.text.7cd1a55d')); ?></td>
                                            <td>$499.00</td>
                                            <td>10</td>
                                            <td>4.4 ★</td>
                                    ...
                                    <table class="table">
                                        <thead class="sample-table-head-tinted">
                                            <tr>
                                                ...
                                                <th><?php echo sr_e(sr_t('admin::ui.text.f6b350f7')); ?></th>
                                                <th><?php echo sr_e(sr_t('admin::ui.status.e10195a1')); ?></th>
                                                <th class="sample-table-action-cell"><?php echo sr_e(sr_t('admin::ui.text.01dfd369')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="sample-table-inverse-cell"><?php echo sr_e(sr_t('admin::ui.text.9a13d293')); ?>
                                                </td>
                                                <td><?php echo sr_e(sr_t('admin::ui.text.7cd1a55d')); ?></td>
                                                <td>$499.00</td>
                                                <td>10</td>
                                ...
                                <div class="table-wrapper">
                                    <table class="table">
                                        <thead class="sample-table-head">
                                            <tr>
                                                <th><?php echo sr_e(sr_t('admin::ui.text.cf71a62a')); ?></th>
                                                <td class="sample-table-head-cell"><?php echo sr_e(sr_t('admin::ui.text.b68c7d1b')); ?></td>
                                                <th><?php echo sr_e(sr_t('admin::ui.text.38c1b407')); ?></th>
                                                <td class="sample-table-head-cell"><?php echo sr_e(sr_t('admin::ui.text.6e1b9aec')); ?></td>
                                                <th><?php echo sr_e(sr_t('admin::ui.text.f6b350f7')); ?></th>
                                                <td class="sample-table-head-cell"><?php echo sr_e(sr_t('admin::ui.status.e10195a1')); ?></td>
                                                <th class="sample-table-action-cell"><?php echo sr_e(sr_t('admin::ui.text.01dfd369')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.f34403ae')); ?></td>
                                                <td class="sample-table-muted-cell"><?php echo sr_e(sr_t('admin::ui.text.2059709c')); ?></td>
                                                <td>$49.00</td>
                                            ...
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.ddc3cc33')); ?></td>
                                                <td class="sample-table-muted-cell"><?php echo sr_e(sr_t('admin::ui.text.4f972c4b')); ?></td>
                                                <td>$29.99</td>
                                            ...
                                            <tr>
                                                <td class="sample-table-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.9e59e6ef')); ?></td>
                                                <td class="sample-table-muted-cell"><?php echo sr_e(sr_t('admin::ui.text.a274b299')); ?></td>
                                                <td>$89.00</td>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo sr_e(sr_t('admin::ui.text.f6b350f7')); ?></th>
                                                <th><?php echo sr_e(sr_t('admin::ui.status.e10195a1')); ?></th>
                                                <th class="sample-table-align-end" style="width: 1%"><?php echo sr_e(sr_t('admin::ui.text.01dfd369')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                            ...
                            <div class="card-body">
                                <div class="table-wrapper">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="sample-table-padded-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.f34403ae')); ?></td>
                                            ...
                                            <tr>
                                                <td class="sample-table-padded-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.ddc3cc33')); ?></td>
                                            ...
                                            <tr>
                                                <td class="sample-table-padded-primary-cell"><?php echo sr_e(sr_t('admin::ui.text.9e59e6ef')); ?></td>
                                    ...
                                    <table class="table">
                                        <thead class="sample-surface-dark">
                                            <tr class="sample-children-inverse">
                                                <th class="sample-table-align-start"><?php echo sr_e(sr_t('admin::ui.text.cf71a62a')); ?></th>
                                                <th><?php echo sr_e(sr_t('admin::ui.text.b68c7d1b')); ?></th>
                                                <th><?php echo sr_e(sr_t('admin::ui.text.38c1b407')); ?></th>
                                                <th><?php echo sr_e(sr_t('admin::ui.text.6e1b9aec')); ?></th>
                                                <th><?php echo sr_e(sr_t('admin::ui.text.f6b350f7')); ?></th>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <thead class="sample-table-head">
                                            <tr>
                                                ...
                                                <th><?php echo sr_e(sr_t('admin::ui.text.f6b350f7')); ?></th>
                                                <th><?php echo sr_e(sr_t('admin::ui.status.e10195a1')); ?></th>
                                                <th class="sample-table-padded-action-cell"><?php echo sr_e(sr_t('admin::ui.text.01dfd369')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
