...
<div class="container-fluid">
                    <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-base">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.modals.c78d69ef')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.7e7bb680')); ?></p>
                                <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                    ...
                                    <div>
                                        <button type="button"
                                            ...
                                            data-overlay="#standard-modal"><?php echo sr_e(sr_t('admin::ui.text.a31d2287')); ?></button>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.e21b042b')); ?></p>
                                                        <p><?php echo sr_e(sr_t('admin::ui.active.e8f7e1aa')); ?></p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-overlay="#standard-modal"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>

                                                        <button type="button"
                                                            class="btn btn-solid-primary modal-action"><?php echo sr_e(sr_t('admin::ui.save.cc69ae1b')); ?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-solid-primary"
                                            ...
                                            data-overlay="#bs-example-modal-lg"><?php echo sr_e(sr_t('admin::ui.text.efbc0d6c')); ?></button>
                                    ...
                                    <div>
                                        <button type="button"
                                            ...
                                            data-overlay="#bs-example-modal-sm"><?php echo sr_e(sr_t('admin::ui.text.87b9e8c6')); ?></button>
                                    ...
                                    <div>
                                        <button type="button"
                                            class="btn btn-solid-primary"
                                            aria-haspopup="dialog" aria-expanded="false"
                                            aria-controls="full-width-modal" data-overlay="#full-width-modal"><?php echo sr_e(sr_t('admin::ui.all.0c976cbf')); ?></button>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p><?php echo sr_e(sr_t('admin::ui.active.14f74c3f')); ?></p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-soft-default modal-action"
                                                            data-overlay="#full-width-modal"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                    ...
                                    <div>
                                        <button type="button"
                                            ...
                                            aria-haspopup="dialog" aria-expanded="false"
                                            aria-controls="scrollable-modal" data-overlay="#scrollable-modal"><?php echo sr_e(sr_t('admin::ui.text.1a3608ec')); ?></button>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="modal-body-scroll">
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.c990082a')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.all.f294c133')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.a2124c01')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.08bab8cd')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.68f743d8')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.0a5185cd')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.5c726503')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.ux.active.08e9823e')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.036164df')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.d94ecc29')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.44457493')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.0eb2d7ab')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.e3dcdf0d')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.2c6a529e')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.d80e89e6')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.223f5dbb')); ?></p>
                                                        <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.text.049fe5f6')); ?></p>
                                                        <p><?php echo sr_e(sr_t('admin::ui.text.b9c6aa3d')); ?></p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-overlay="#scrollable-modal"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.modal.position.60f37d79')); ?></h4>
                        </div>

                        <div class="card-body">
                            <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.page.354cddad')); ?></p>
                            ...
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        data-overlay="#top-modal"><?php echo sr_e(sr_t('admin::ui.text.9b2af47e')); ?></button>
                                    ...
                                    <div id="top-modal"
                                        ...
                                        <div class="modal-dialog">
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <h5 class="ui-kit-space-after-2"><?php echo sr_e(sr_t('admin::ui.text.e2e62d72')); ?></h5>
                                                    <p><?php echo sr_e(sr_t('admin::ui.notification.settings.623a999c')); ?></p>
                                                </div>

                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#top-modal"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>

                                                    <button type="button"
                                                        class="btn btn-solid-primary modal-action"><?php echo sr_e(sr_t('admin::ui.save.011c4ffe')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        data-overlay="#bottom-modal"><?php echo sr_e(sr_t('admin::ui.text.08c1e17c')); ?></button>
                                    ...
                                    <div id="bottom-modal"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <h5 class="ui-kit-space-after-2"><?php echo sr_e(sr_t('admin::ui.text.e2e62d72')); ?></h5>
                                                    <p><?php echo sr_e(sr_t('admin::ui.active.660b1c39')); ?></p>
                                                </div>

                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#bottom-modal"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        data-overlay="#centermodal"><?php echo sr_e(sr_t('admin::ui.text.aafa9b08')); ?></button>
                                    ...
                                    <div id="centermodal"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <h5 class="ui-kit-space-after-2"><?php echo sr_e(sr_t('admin::ui.text.e2e62d72')); ?></h5>
                                                    <p><?php echo sr_e(sr_t('admin::ui.active.dc3e0c96')); ?></p>
                                                </div>

                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#centermodal"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.multiple.modal.4d07d17a')); ?></h4>
                        </div>

                        <div class="card-body">
                            <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.623f1f1c')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                <!-- Modal Heading -->
                                <div>
                                    <button type="button"
                                        ...
                                        data-overlay="#multiple-one"><?php echo sr_e(sr_t('admin::ui.text.3303bc36')); ?></button>
                                    ...
                                    <div id="multiple-one"
                                        ...
                                        <div class="modal-dialog">
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <h5 class="ui-kit-space-after-2"><?php echo sr_e(sr_t('admin::ui.text.6a7618af')); ?></h5>
                                                    <p><?php echo sr_e(sr_t('admin::ui.text.6745faf4')); ?></p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-solid-primary"
                                                        aria-haspopup="dialog" aria-expanded="false"
                                                        aria-controls="multiple-two" data-overlay="#multiple-two"><?php echo sr_e(sr_t('admin::ui.text.63cd5285')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="multiple-two"
                                        ...
                                        <div class="ui-kit-outer-space-3 ui-kit-inline-margin-sm-auto ui-kit-fill-width-sm ui-kit-max-width-sm-lg">
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <h5 class="ui-kit-space-after-2"><?php echo sr_e(sr_t('admin::ui.text.54c1bfe3')); ?></h5>
                                                    <p><?php echo sr_e(sr_t('admin::ui.close.6278c252')); ?></p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-overlay="#multiple-two"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.toggle.between.modals.75a64fa1')); ?></h4>
                        </div>

                        <div class="card-body">
                            <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><code>data-overlay</code> <?php echo sr_e(sr_t('admin::ui.text.1f4997e4')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                <div>
                                    <button type="button"
                                        class="btn btn-solid-secondary"
                                        aria-haspopup="dialog" aria-expanded="false" aria-controls="exampleModalToggle1"
                                        data-overlay="#exampleModalToggle1"><?php echo sr_e(sr_t('admin::ui.text.fdc5ece2')); ?></button>
                                    ...
                                    <div id="exampleModalToggle1"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <p><?php echo sr_e(sr_t('admin::ui.active.c4b6564e')); ?></p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <?php echo sr_e(sr_t('admin::ui.text.a6a62630')); ?>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="exampleModalToggle2"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <p><?php echo sr_e(sr_t('admin::ui.text.291f1669')); ?></p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-solid-primary modal-action"
                                                        data-overlay="#exampleModalToggle1"><?php echo sr_e(sr_t('admin::ui.text.56db1f70')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.all.fullscreen.modal.cfc5e840')); ?></h4>
                        </div>

                        <div class="card-body">
                            <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.all.07d37118')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                <!-- Full Screen Modal -->
                                <div>
                                    <button type="button"
                                        ...
                                        data-overlay="#fullscreeexampleModal"><?php echo sr_e(sr_t('admin::ui.all.a511f914')); ?></button>
                                    ...
                                    <div id="fullscreeexampleModal"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="modal-body-fill"><?php echo sr_e(sr_t('admin::ui.text.01025abc')); ?></div>

                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#fullscreeexampleModal"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <?php echo sr_e(sr_t('admin::ui.sm.all.46c07fe1')); ?>
                                    </button>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#exampleModalFullscreenSm"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <?php echo sr_e(sr_t('admin::ui.md.all.72277b49')); ?>
                                    </button>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#exampleModalFullscreenMd"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <?php echo sr_e(sr_t('admin::ui.lg.all.e1be95a5')); ?>
                                    </button>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#exampleModalFullscreenLg"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <?php echo sr_e(sr_t('admin::ui.xl.all.73cd73a0')); ?>
                                    </button>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#exampleModalFullscreenXl"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <?php echo sr_e(sr_t('admin::ui.xxl.all.9f6190c6')); ?>
                                    </button>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#exampleModalFullscreenXxl"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.static.backdrop.3e621249')); ?></h4>
                        </div>

                        <div class="card-body">
                            <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.static.settings.4d8a4647')); ?></p>
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                <!-- Static Backdrop modal -->
                                <div>
                                    <button type="button" class="btn btn-solid-info"
                                        aria-haspopup="dialog" aria-expanded="false" aria-controls="staticBackdrop"
                                        data-overlay="#staticBackdrop"><?php echo sr_e(sr_t('admin::ui.text.b1ec1529')); ?></button>
                                    ...
                                    <div id="staticBackdrop"
                                        ...
                                        <div class="modal-dialog">
                                            <div
                                                ...
                                                <div class="modal-body">
                                                    <p><?php echo sr_e(sr_t('admin::ui.esc.settings.6c5eaa31')); ?></p>
                                                </div>

                                                <div class="modal-footer">
                                                    <button type="button"
                                                        class="btn btn-solid-secondary modal-action"
                                                        data-overlay="#staticBackdrop"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
