                            ...
                            <div class="ui-kit-cluster ui-kit-wrap ui-kit-gap-2-5">
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <?php echo sr_e(sr_t('admin::ui.small.screen.fullscreen.modal.2e7a3c40')); ?>
                                    </button>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <h3 id="exampleModalFullscreenSmall-label"
                                                        class="modal-title"><?php echo sr_e(sr_t('admin::ui.small.screen.fullscreen.modal.2e7a3c40')); ?></h3>
                                                ...
                                                <div
                                                    class="modal-footer">
                                                    <button type="button" class="btn btn-soft-default modal-action"
                                                        data-overlay="#exampleModalFullscreenSmall"><?php echo sr_e(sr_t('admin::ui.close.1e8c1020')); ?></button>
