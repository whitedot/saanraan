...
<div class="container-fluid">
                    ...
                    <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-md-3 ui-kit-gap-base">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.text.51f44d20')); ?></h4>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-space-after-4"><?php echo sr_e(sr_t('admin::ui.active.3fe0c8fa')); ?></p>
                                <p><?php echo sr_e(sr_t('admin::ui.text.2d361639')); ?></p>
                            </div>
                            <!-- 카드 본문 끝-->
                        </div>
                        <!-- 카드 끝-->
                    ...
                    <div class="card-filtering sample-card-filtering card-filtering-open" data-card-filtering>
                        <div class="card-filtering-basic">
                            ...
                            <div class="card-filtering-field">
                                <label for="admin_ui_card_filtering_keyword" class="form-label"><?php echo sr_e(sr_t('admin::ui.card.filtering.keyword')); ?></label>
                                <input id="admin_ui_card_filtering_keyword" type="text" class="form-input" value="<?php echo sr_e(sr_t('admin::ui.card.filtering.sample')); ?>">
                            </div>
                        </div>
                        <div id="admin_ui_card_filtering_detail" class="card-filtering-body" data-card-filtering-body>
                            <div class="card-filtering-field">
                                <label for="admin_ui_card_filtering_category" class="form-label"><?php echo sr_e(sr_t('admin::ui.card.filtering.category')); ?></label>
                                <select id="admin_ui_card_filtering_category" class="form-select">
                                    <option value=""><?php echo sr_e(sr_t('admin::ui.card.filtering.option.all')); ?></option>
                                    <option><?php echo sr_e(sr_t('admin::ui.card.filtering.option.notice')); ?></option>
                                    <option><?php echo sr_e(sr_t('admin::ui.card.filtering.option.guide')); ?></option>
                                </select>
                            </div>
                            <div class="card-filtering-field">
                                <label for="admin_ui_card_filtering_category_group_tags_select" class="form-label"><?php echo sr_e(sr_t('admin::ui.card.filtering.category.group_tags')); ?></label>
                                <div id="admin_ui_card_filtering_category_group_tags" class="admin-select-badge-list" data-admin-select-badge-list data-admin-select-badge-name="admin_ui_card_filtering_category_group_tags">
                                    <select id="admin_ui_card_filtering_category_group_tags_select" class="form-select admin-select-badge-list-select" data-admin-select-badge-list-select>
                                        <option value=""><?php echo sr_e(sr_t('admin::ui.card.filtering.option.all')); ?></option>
                                        <option value="notice" data-admin-select-badge-label="<?php echo sr_e(sr_t('admin::ui.card.filtering.option.notice')); ?>" data-admin-select-badge-summary="<?php echo sr_e(sr_t('admin::ui.card.filtering.tag.summary.default')); ?>"><?php echo sr_e(sr_t('admin::ui.card.filtering.option.notice')); ?></option>
                                        <option value="guide" data-admin-select-badge-label="<?php echo sr_e(sr_t('admin::ui.card.filtering.option.guide')); ?>" data-admin-select-badge-summary="<?php echo sr_e(sr_t('admin::ui.card.filtering.tag.summary.operations')); ?>"><?php echo sr_e(sr_t('admin::ui.card.filtering.option.guide')); ?></option>
                                    </select>
                                    <div class="badge-list" data-admin-select-badge-list-items>
                                        <span class="badge-list-item" data-admin-select-badge-item>
                                            <span class="badge-list-label"><?php echo sr_e(sr_t('admin::ui.card.filtering.option.notice')); ?></span>
                                            <span class="badge-list-summary"><?php echo sr_e(sr_t('admin::ui.card.filtering.tag.summary.default')); ?></span>
                                            <input type="hidden" name="admin_ui_card_filtering_category_group_tags[]" value="notice" data-admin-select-badge-value>
                                        ...
                                        <span class="badge-list-item" data-admin-select-badge-item>
                                            <span class="badge-list-label"><?php echo sr_e(sr_t('admin::ui.card.filtering.option.guide')); ?></span>
                                            <span class="badge-list-summary"><?php echo sr_e(sr_t('admin::ui.card.filtering.tag.summary.operations')); ?></span>
                                            <input type="hidden" name="admin_ui_card_filtering_category_group_tags[]" value="guide" data-admin-select-badge-value>
                                            <button type="button" class="btn btn-icon-xs btn-ghost-danger admin-select-badge-list-remove" data-admin-select-badge-remove aria-label="선택 항목 제거">×</button>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.text.1ead5386')); ?></h4>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.text.e4e1145f')); ?></h4>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.text.c031fc05')); ?></h4>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.text.a5c65a09')); ?></h4>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('admin::ui.text.e5455d80')); ?></h4>
                            </div>
