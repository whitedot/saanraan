...
function sr_admin_code_label_context_options(): array
{
    return [
        'module_key' => [
            'admin' => '관리자',
            'antispam' => '자동등록방지',
            'antispam_captcha_providers' => '자동등록방지 CAPTCHA 제공자',
        ...
        'target_type' => [
            ...
            'asset_exchange_log' => '포인트/금액 환전 기록',
            'asset_exchange_policy' => '포인트/금액 환전 정책',
            ...
            'community_board_copy_job' => '커뮤니티 게시판 복사 작업',
            'community_board_group' => '커뮤니티 게시판 그룹',
            'community_category' => '커뮤니티 분류',
            'community_series' => '커뮤니티 시리즈',
            'community_storage_cleanup_failure' => '커뮤니티 저장소 정리 실패',
            'content' => '콘텐츠',
            'content_asset_policy_set' => '콘텐츠 포인트/금액 정책',
            'content_author_application' => '콘텐츠 등록자 신청',
            'content_comment' => '콘텐츠 댓글',
            'content_file' => '콘텐츠 파일',
            'content_file_download' => '콘텐츠 파일 다운로드',
            'content_group' => '콘텐츠 그룹',
            'content_series' => '콘텐츠 시리즈',
            'content_storage_cleanup_failure' => '콘텐츠 저장소 정리 실패',
            'post' => '게시글',
            'comment' => '댓글',
            'message' => '쪽지',
            'banner' => '배너',
            ...
            'notification' => '알림',
            'notification_delivery' => '알림 발송 작업',
            'notification_push_endpoint' => '푸시 알림 기기',
            ...
            'reward_withdrawal_request' => '적립금 출금 신청',
            'storage_cache' => '저장소 캐시',
            'survey.form' => '설문',
            'survey.response' => '설문 응답',
            'survey_comment' => '설문 댓글',
            'survey_form' => '설문',
        ],
        'boolean' => [
            '0' => '아니오',
...
function sr_admin_event_type_label_options(): array
{
    return [
        ...
        'privacy.request.updated' => '개인정보 요청 대응 기록 상태 변경',
...
function sr_admin_module_description_label(string $description): string
{
    $labels = [
        ...
        'Site notification and external delivery queue module.' => '사이트 알림과 알림 발송 작업을 관리합니다.',
