...
function sr_admin_comment_extra_fields_editor_html(string $id, string $name, mixed $value, string $title = '댓글 추가 입력 항목', string $help = '', string $footerHtml = ''): string
{
    ...
    ob_start();
    ?>
    <section id="<?php echo sr_e($safeId); ?>-section" class="card admin-comment-extra-fields" data-admin-comment-extra-fields-editor data-admin-section-anchor>
        ...
        <div class="table-wrapper" data-admin-comment-extra-field-table-wrap hidden>
            <table class="table table-list">
                ...
                <thead><tr><th class="admin-comment-extra-field-order">순서</th><th>라벨</th><th>유형</th><th>개인정보 처리</th><th class="text-end">작업</th></tr></thead>
        ...
        <div id="<?php echo sr_e($modalId); ?>" class="overlay" role="dialog" aria-modal="true" aria-labelledby="<?php echo sr_e($modalId); ?>-title" data-admin-comment-extra-field-modal>
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer"><button type="button" class="btn btn-solid-light" data-overlay="#<?php echo sr_e($modalId); ?>">닫기</button><button type="button" class="btn btn-solid-primary" data-admin-comment-extra-field-save>적용</button></div>
                </div>
            </div>
        </div>
    </section>
