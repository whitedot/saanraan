...
function toy_admin_audit_log_display_message(array $log): string
{
    ...
    $labels = [
        ...
        'Privacy request updated.' => '개인정보 요청이 변경되었습니다.',
        'Privacy request export reauthentication blocked by throttle.' => '개인정보 요청 내보내기 재인증이 제한 정책으로 차단되었습니다.',
        'Privacy request export reauthentication failed.' => '개인정보 요청 내보내기 재인증에 실패했습니다.',
        'Privacy request export downloaded.' => '개인정보 요청 내보내기 파일이 다운로드되었습니다.',
        ...
        'Privacy request list viewed.' => '개인정보 요청 목록을 조회했습니다.',
