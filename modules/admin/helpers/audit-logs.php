...
function sr_admin_audit_log_display_message(array $log): string
{
    ...
    $labels = [
        ...
        'Privacy request created.' => '개인정보 요청 대응 기록이 생성되었습니다.',
        'Privacy request updated.' => '개인정보 요청 대응 기록이 변경되었습니다.',
        'Privacy request export reauthentication blocked by throttle.' => '개인정보 요청 대응 자료 다운로드 재인증이 제한 정책으로 차단되었습니다.',
        'Privacy request export reauthentication failed.' => '개인정보 요청 대응 자료 다운로드 재인증에 실패했습니다.',
        'Privacy request export downloaded.' => '개인정보 요청 대응 자료 파일이 다운로드되었습니다.',
        'Site setting saved.' => '사이트 설정 항목이 저장되었습니다.',
        'Site setting deleted.' => '사이트 설정 항목이 삭제되었습니다.',
        'Site settings updated.' => '사이트 설정이 변경되었습니다.',
        'Site default currency changed.' => '사이트 기본 통화가 변경되었습니다.',
        'Site default currency reauthentication blocked by throttle.' => '사이트 기본 통화 변경 재인증이 제한 정책으로 차단되었습니다.',
        'Site default currency reauthentication failed.' => '사이트 기본 통화 변경 재인증에 실패했습니다.',
        ...
        'Admin role changed.' => '관리 권한이 변경되었습니다.',
        'Admin permissions changed.' => '관리 권한이 변경되었습니다.',
        'Admin settings updated.' => '관리자 설정이 변경되었습니다.',
        'Admin menu display settings updated.' => '관리자 메뉴 표시 설정이 변경되었습니다.',
        'Privacy request list viewed.' => '개인정보 요청 대응 기록 목록을 조회했습니다.',
        ...
        'Admin permission change reauthentication blocked by throttle.' => '관리 권한 변경 재인증이 제한 정책으로 차단되었습니다.',
        'Admin permission change reauthentication failed.' => '관리 권한 변경 재인증에 실패했습니다.',
        ...
        'Community message sent.' => '쪽지가 발송되었습니다.',
        'Community message deleted by account.' => '쪽지가 계정에 의해 삭제되었습니다.',
