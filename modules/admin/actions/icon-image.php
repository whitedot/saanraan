...
$storageReference = sr_get_string('file', 220);
$storage = sr_admin_icon_image_storage_reference($storageReference);
if (!is_array($storage)) {
...
if (!sr_admin_icon_image_mime_is_allowed($mimeType) || !is_int($sizeBytes)) {
    sr_render_error(404, '요청한 아이콘 이미지를 찾을 수 없습니다.');
}
