...
$contentCommentExtraFieldDefinitions = sr_comment_extra_field_definitions($page['comment_extra_fields_json'] ?? '[]');
$contentCommentExtraFieldValues = isset($_SESSION['sr_content_comment_extra_field_values']) && is_array($_SESSION['sr_content_comment_extra_field_values']) ? $_SESSION['sr_content_comment_extra_field_values'] : [];
unset($_SESSION['sr_content_comment_notice'], $_SESSION['sr_content_comment_errors'], $_SESSION['sr_content_comment_body'], $_SESSION['sr_content_comment_is_secret'], $_SESSION['sr_content_comment_parent_id'], $_SESSION['sr_content_comment_extra_field_values']);
