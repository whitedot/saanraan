...
$policySetFilters = [
    'status' => sr_admin_get_allowed_array('status', sr_content_asset_policy_set_statuses(), 30),
...
$policySets = array_values(array_filter(sr_content_asset_policy_sets($pdo, false, $policySetSort), static function (array $policySet) use ($policySetFilters): bool {
