                    ...
                    <div class="ui-kit-grid ui-kit-grid-1 ui-kit-gap-base">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.custom.styles.validation.e4e968f6')); ?></h4>
                            </div>
                            <div class="card-body">
                                <form id="customValidationForm" class="ui-kit-grid ui-kit-grid-md-12 ui-kit-grid-1 ui-kit-gap-base"
                                    ...
                                    <div class="ui-kit-column-md-4">
                                        <label class="form-label" for="customFirstName"><?php echo sr_e(sr_t('ui.name.first.name.1a3108a8')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                    ...
                                    <!-- Last Name -->
                                    <div class="ui-kit-column-md-4">
                                        <label class="form-label" for="customLastName"><?php echo sr_e(sr_t('ui.last.name.9b3ddc78')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                    ...
                                    <!-- Username -->
                                    <div class="ui-kit-column-md-4">
                                        <label class="form-label" for="customUsername"><?php echo sr_e(sr_t('ui.active.name.username.b19d3d5e')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                    ...
                                    <div class="ui-kit-column-md-6">
                                        <label class="form-label" for="customCity"><?php echo sr_e(sr_t('ui.city.68649934')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                    ...
                                    <div class="ui-kit-column-md-3">
                                        <label class="form-label" for="customState"><?php echo sr_e(sr_t('ui.state.b93c5a3b')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>

                                        <div class="validation-field">
                                            <select id="customState" required class="input-field form-select">
                                                <option value=""><?php echo sr_e(sr_t('ui.select.5b1efda0')); ?></option>
                                    ...
                                    <!-- Zip -->
                                    <div class="ui-kit-column-md-3">
                                        <label class="form-label" for="customZip"><?php echo sr_e(sr_t('ui.zip.code.45119a29')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                    ...
                                    <div class="ui-kit-column-md-12">
                                        <button type="submit"
                                            class="btn btn-solid-primary"><?php echo sr_e(sr_t('ui.submit.form.58504893')); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.server.side.28a1abe1')); ?></h4>
                            </div>
                            <div class="card-body">
                                <form id="serverForm" class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-md-12 ui-kit-gap-base" novalidate>
                                    <!-- First name -->
                                    <div class="ui-kit-column-md-4">
                                        <label for="serverFirstName" class="form-label"><?php echo sr_e(sr_t('ui.name.first.name.04ab2143')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        <div class="validation-field">
                                            <input type="text" id="serverFirstName" value="Mark" required
                                                class="form-input form-input-valid" />
                                            <div
                                                class="validation-static-icon">
                                                <?php echo sr_material_icon_html('check', 'validation-success-icon', sr_t('ui.text.35688a85')); ?>
                                            </div>
                                        </div>
                                        <p class="validation-success-note"><?php echo sr_e(sr_t('ui.text.78dc433d')); ?></p>
                                    </div>

                                    <!-- Last name -->
                                    <div class="ui-kit-column-md-4">
                                        <label for="serverLastName" class="form-label"><?php echo sr_e(sr_t('ui.last.name.dfe12126')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        <div class="validation-field">
                                    ...
                                    <div class="ui-kit-column-md-4">
                                        ...
                                        <div class="validation-field ui-kit-cluster sample-radius-md">
                                            ...
                                            <div
                                                class="validation-static-icon">
                                                <?php echo sr_material_icon_html('info', 'validation-error-icon', sr_t('ui.text.b8cf07ac')); ?>
                                            </div>
                                        </div>
                                        <p class="validation-error-note"><?php echo sr_e(sr_t('ui.active.name.select.4de06bf1')); ?></p>
                                    </div>

                                    <!-- City -->
                                    <div class="ui-kit-column-md-6">
                                        <label for="serverCity" class="form-label"><?php echo sr_e(sr_t('ui.city.68649934')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        <div class="validation-field">
                                            <input type="text" id="serverCity" required placeholder="<?php echo sr_e(sr_t('ui.text.51c3d48a')); ?>"
                                        ...
                                        <p class="validation-error-note"><?php echo sr_e(sr_t('ui.text.09359b44')); ?></p>
                                    </div>

                                    <!-- State -->
                                    <div class="ui-kit-column-md-3">
                                        <label for="serverState" class="form-label"><?php echo sr_e(sr_t('ui.state.b93c5a3b')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        <div class="validation-field">
                                        ...
                                        <p class="validation-error-note"><?php echo sr_e(sr_t('ui.select.cf278ee1')); ?></p>
                                    </div>

                                    <!-- Zip -->
                                    <div class="ui-kit-column-md-3">
                                        <label for="serverZip" class="form-label"><?php echo sr_e(sr_t('ui.zip.918b7b76')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        <div class="validation-field">
                                            <input type="text" id="serverZip" required placeholder="<?php echo sr_e(sr_t('ui.text.1b50041e')); ?>"
                                                class="form-input form-input-invalid" />
                                            <div
                                                class="validation-static-icon">
                                                <?php echo sr_material_icon_html('info', 'validation-error-icon', sr_t('ui.text.b8cf07ac')); ?>
                                        ...
                                        <p class="validation-error-note"><?php echo sr_e(sr_t('ui.text.286154b2')); ?></p>
                                    </div>
                                    ...
                                    <div class="ui-kit-column-md-12">
                                        <label class="ui-kit-cluster ui-kit-align-items-center ui-kit-inline-space-2" for="serverTerms">
                                            ...
                                            <span class="validation-danger-label"><?php echo sr_e(sr_t('ui.text.07231b0d')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></span>
                                        </label>
                                        <p class="validation-error-note"><?php echo sr_e(sr_t('ui.text.e3bc5fd9')); ?></p>
                                    </div>

                                    <!-- Submit Button -->
                                    <div class="ui-kit-column-md-12">
                                        <button type="submit"
                                            class="btn btn-solid-primary"><?php echo sr_e(sr_t('ui.submit.form.353c958a')); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.supported.elements.3d56cb84')); ?></h4>
                            </div>
                            <div class="card-body">
                                <form class="ui-kit-stack-6" novalidate>
                                    <!-- Textarea -->
                                    <div>
                                        <label for="validationTextarea" class="form-label"><?php echo sr_e(sr_t('ui.textarea.9cbf1bae')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        <textarea id="validationTextarea" placeholder="<?php echo sr_e(sr_t('ui.required.9ac81744')); ?>" required
                                            class="form-textarea form-textarea-invalid"></textarea>
                                        <p class="validation-error-note"><?php echo sr_e(sr_t('ui.text.e7b2bd4a')); ?></p>
                                    </div>
                                    ...
                                    <div class="ui-kit-cluster ui-kit-align-items-start ui-kit-gap-2">
                                        ...
                                        <div>
                                            <label for="validationFormCheck1" class="validation-danger-label"><?php echo sr_e(sr_t('ui.text.31cc6171')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <p class="validation-error-note"><?php echo sr_e(sr_t('ui.text.3388da7e')); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ui-kit-stack-2">
                                        <div class="ui-kit-cluster ui-kit-align-items-center ui-kit-gap-2">
                                            ...
                                            <label for="validationFormCheck2" class="validation-danger-label"><?php echo sr_e(sr_t('ui.text.724f8e18')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        </div>

                                        <div class="ui-kit-cluster ui-kit-align-items-center ui-kit-gap-2">
                                            <input id="validationFormCheck3" type="radio" name="radio-stacked" required
                                                class="form-radio form-choice-danger form-choice-invalid" />
                                            <label for="validationFormCheck3" class="validation-danger-label"><?php echo sr_e(sr_t('ui.text.2407692e')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <p class="validation-error-note"><?php echo sr_e(sr_t('ui.text.6905bf2e')); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <button type="submit" disabled
                                            class="btn btn-solid-primary"><?php echo sr_e(sr_t('ui.submit.form.449afbaf')); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.browser.defaults.8abc599f')); ?></h4>
                            </div>
                            <div class="card-body">
                                <form action="">
                                    <div class="ui-kit-grid ui-kit-grid-md-3 ui-kit-grid-1 ui-kit-gap-base ui-kit-space-after-base">
                                        <div>
                                            <label for="validationDefault01" class="form-label"><?php echo sr_e(sr_t('ui.name.first.name.04ab2143')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <input type="text" class="form-input" id="validationDefault01" value="Mark"
                                                required="" />
                                        </div>

                                        <div>
                                            <label for="validationDefault02" class="form-label"><?php echo sr_e(sr_t('ui.last.name.dfe12126')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <input type="text" class="form-input" id="validationDefault02" value="Otto"
                                                required="" />
                                        </div>

                                        <div>
                                            <label for="validationDefaultUsername" class="form-label"><?php echo sr_e(sr_t('ui.active.name.username.e89a222c')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                    ...
                                    <div class="ui-kit-grid ui-kit-grid-md-4 ui-kit-grid-1 ui-kit-gap-base ui-kit-space-after-base">
                                        <div class="ui-kit-column-md-2 ui-kit-column-1">
                                            <label for="validationDefault03" class="form-label"><?php echo sr_e(sr_t('ui.city.68649934')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <input type="text" class="form-input" id="validationDefault03"
                                                required="" />
                                        </div>

                                        <div>
                                            <label for="validationDefault04" class="form-label"><?php echo sr_e(sr_t('ui.state.b93c5a3b')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <select class="form-select" id="validationDefault04" required="">
                                                <option selected="" disabled="" value=""><?php echo sr_e(sr_t('ui.select.5b1efda0')); ?></option>
                                                <option>...</option>
                                            </select>
                                        </div>

                                        <div>
                                            <label for="validationDefault05" class="form-label"><?php echo sr_e(sr_t('ui.zip.918b7b76')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                    ...
                                    <div class="ui-kit-space-before-base">
                                        <button class="btn btn-solid-primary"
                                            type="submit"><?php echo sr_e(sr_t('ui.submit.form.d55e232f')); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
