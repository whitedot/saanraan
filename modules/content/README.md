...
- 콘텐츠 그룹이 사이트 메뉴 연결 자산과 sitemap 후보에 포함
...
- 복합 차감 자산의 차감 우선순위: 포인트 > 적립금 > 예치금
- 최초 1회 차감 정책은 같은 회원/콘텐츠/자산 조합을 중복 차감하지 않음
- 다운로드 과금은 파일별 최초 1회 또는 매 다운로드 정책을 따름
- 완료 버튼 자산 처리는 회원별 1회만 처리하고 지급/차감 원장을 남김
