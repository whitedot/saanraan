...
function sr_content_input_values(?PDO $pdo = null): array
{
    ...
    $values = [
        ...
        'reaction_preset_key' => $pdo instanceof PDO && function_exists('sr_reaction_setting_preset_key_or_disabled') ? sr_reaction_setting_preset_key_or_disabled($pdo, sr_post_string('reaction_preset_key', 80)) : '',
        'reaction_comment_preset_key' => $pdo instanceof PDO && function_exists('sr_reaction_setting_preset_key_or_disabled') ? sr_reaction_setting_preset_key_or_disabled($pdo, sr_post_string('reaction_comment_preset_key', 80)) : '',
    ...
    try {
        ...
        if (is_array($existing)) {
            ...
            $stmt->execute([
                ...
                'reaction_preset_key' => function_exists('sr_reaction_setting_preset_key_or_disabled') ? sr_reaction_setting_preset_key_or_disabled($pdo, $values['reaction_preset_key'] ?? '') : '',
                'reaction_comment_preset_key' => function_exists('sr_reaction_setting_preset_key_or_disabled') ? sr_reaction_setting_preset_key_or_disabled($pdo, $values['reaction_comment_preset_key'] ?? '') : '',
