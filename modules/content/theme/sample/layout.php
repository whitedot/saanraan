...
$layoutBusinessInfoHtml = $layoutBusinessInfoVisible ? sr_site_business_info_html($layoutPdo, 'content-layout') : '';
if ($layoutPdo instanceof PDO && sr_module_enabled($layoutPdo, 'logo_manager') && is_file(SR_ROOT . '/modules/logo_manager/helpers.php')) {
    ...
    $layoutFooterBrandLogoHtml = sr_logo_manager_render_logo($layoutPdo, 'public.header.desktop', $layoutSite, [
        'class' => 'content-layout-brand-logo content-layout-footer-logo content-layout-brand-logo-desktop',
        'fallback_position_key' => 'public.header.mobile',
        'layout_provider_key' => 'content',
    ...
    $layoutFooterMobileBrandLogoHtml = sr_logo_manager_render_logo($layoutPdo, 'public.header.mobile', $layoutSite, [
        'class' => $layoutFooterBrandLogoHtml !== ''
            ? 'content-layout-brand-logo content-layout-footer-logo content-layout-brand-logo-mobile'
            : 'content-layout-brand-logo content-layout-footer-logo',
        'fallback_position_key' => 'public.header.desktop',
        'layout_provider_key' => 'content',
        'usage_slot_key' => 'bottom',
        'allow_untargeted_fallback' => false,
...
<body class="<?php echo sr_e(trim('content-layout-body example-content-layout-shell ' . $layoutBodyClass)); ?>" data-example-theme-layout="content.sample">
    ...
    <header class="content-layout-header">
        <div class="content-layout-topbar">
            ...
            <?php if ($layoutMemberEnabled) { ?>
                    ...
                    <details class="content-layout-member-menu">
                        ...
                        <div class="content-layout-member-dropdown dropdown-menu-profile" role="menu" aria-orientation="vertical">
                            <div class="content-layout-member-dropdown-header dropdown-profile-header">
                                ...
                                <span class="content-layout-member-badge badge badge-pill <?php echo sr_e($layoutMemberBadgeClass); ?>"><?php echo sr_e($layoutMemberBadgeLabel); ?></span>
                            </div>
                            <a class="content-layout-member-dropdown-link dropdown-profile-item" href="<?php echo sr_e(sr_url('/mypage')); ?>" role="menuitem">
                ...
                <?php } else { ?>
                    <a class="content-layout-icon-button content-layout-member-link content-layout-member-link-login" href="<?php echo sr_e(sr_member_login_url_for_current_request()); ?>" aria-label="<?php echo sr_e('로그인'); ?>">
    ...
    <footer class="content-layout-footer">
        <div class="content-layout-footer-row">
            <?php if ($layoutFooterBrandLogoHtml !== '' || $layoutFooterMobileBrandLogoHtml !== '') { ?>
                <a class="content-layout-footer-brand-link" href="<?php echo sr_e($layoutBrandLinkUrl); ?>">
