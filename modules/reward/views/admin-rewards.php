...
<p>
    <a href="<?php echo sr_e(sr_url('/admin/rewards/balances')); ?>">잔액</a>
    |
    <a href="<?php echo sr_e(sr_url('/admin/rewards/adjust')); ?>">조정</a>
    |
    <a href="<?php echo sr_e(sr_url('/admin/rewards/transactions')); ?>">거래 내역</a>
</p>

<section>
    <h2>회원 조회</h2>
    <form method="get" action="<?php echo sr_e(sr_url($rewardAdminPage === 'transactions' ? '/admin/rewards/transactions' : ($rewardAdminPage === 'adjust' ? '/admin/rewards/adjust' : '/admin/rewards/balances'))); ?>">
        <label>회원 공개 해시<br>
...
<?php if ($rewardAdminPage === 'adjust') { ?>
    <section>
        <h2>적립금 조정</h2>
        <form method="post" action="<?php echo sr_e(sr_url('/admin/rewards/adjust' . ($accountIdentifierFilter !== '' ? '?account_identifier=' . rawurlencode($accountIdentifierFilter) : ''))); ?>">
