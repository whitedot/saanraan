...
return static function (PDO $pdo, int $accountId): array {
    ...
    $stmt->execute(['account_id' => $accountId]);
    $expirationConsumptions = sr_privacy_export_limit_rows($stmt->fetchAll(), 'expiration_consumptions', $sectionLimits, 1000);
    ...
    return [
        ...
        'withdrawal_requests' => sr_privacy_export_limit_rows($stmt->fetchAll(), 'withdrawal_requests', $sectionLimits, 1000),
