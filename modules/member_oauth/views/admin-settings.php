...
$memberOauthHelp = [
    ...
    'scope' => [
        ...
        'title' => '가져올 정보 권한 도움말',
        'body' => '<p>외부 로그인 서비스에 요청할 회원 정보 권한입니다. 서비스마다 이메일, 기본 프로필처럼 서로 다른 이름을 사용합니다.</p>'
    ...
    'profile_sync' => [
        ...
        'body' => '<p>외부 계정을 연결하거나 해당 제공자로 로그인할 때, 외부 서비스가 돌려준 값 중 어떤 값을 사이트 회원 정보에 반영할지 정합니다.</p>'
            ...
            . '<p>가져올 값 위치는 외부 로그인 결과에서 회원 정보를 찾을 항목 경로입니다. 서비스 문서에 안내된 응답 항목과 다르게 지정하면 해당 회원 정보가 갱신되지 않습니다.</p>',
    ],
    'sort_order' => [
