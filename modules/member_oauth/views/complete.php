...
<main>
    ...
    <?php } ?>
    <form method="post" action="<?php echo sr_e(sr_url('/oauth/complete')); ?>">
        ...
        <p>
            ...
            <input id="member_oauth_complete_email" type="email" name="email" value="<?php echo sr_e($values['email']); ?>" required>
        </p>
        <p>
            <label for="member_oauth_complete_display_name">이름 <span class="sr-required-label">(필수)</span></label>
            <input id="member_oauth_complete_display_name" type="text" name="display_name" value="<?php echo sr_e($values['display_name']); ?>" required>
        </p>
        <p>
            <label for="member_oauth_complete_password">비밀번호 <span class="sr-required-label">(필수)</span></label>
            <input id="member_oauth_complete_password" type="password" name="password" required>
        </p>
        <p>
            <label for="member_oauth_complete_password_confirm">비밀번호 확인 <span class="sr-required-label">(필수)</span></label>
            <input id="member_oauth_complete_password_confirm" type="password" name="password_confirm" required>
        </p>
