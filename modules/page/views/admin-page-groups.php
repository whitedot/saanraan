...
$adminPageTitle = $pageGroupsPage === 'list' ? sr_t('page::ui.page.5875c5b3') : ($pageGroupsPage === 'edit' ? sr_t('page::ui.page.edit.700b7706') : sr_t('page::ui.page.5a50b240'));
$adminPageSubtitle = $pageGroupsPage === 'list' ? sr_t('page::ui.page.status.page.6193db1c') : sr_t('page::ui.page.list.menu.active.b056b4c2');
...
<?php if ($pageGroupsPage === 'list') { ?>
    <div class="admin-local-nav-wrap">
        <div class="admin-local-nav">
            <a href="<?php echo sr_e(sr_url('/admin/page-groups')); ?>" class="btn btn-solid-light"><?php echo sr_e(sr_t('page::ui.all.e078b14a')); ?></a>
        </div>
        <div class="admin-summary-stats">
            <span class="admin-summary-meta"><?php echo sr_e(sr_t('page::ui.text.ca286213')); ?> <strong><?php echo sr_e((string) $totalPageGroups); ?><?php echo sr_e(sr_t('page::ui.text.a57ab057')); ?></strong></span>
            <a href="<?php echo sr_e(sr_url('/admin/page-groups?status=enabled')); ?>" class="admin-summary-meta"><?php echo sr_e(sr_t('page::ui.active.93c558d7')); ?> <?php echo sr_e((string) ($pageGroupStatusCounts['enabled'] ?? 0)); ?><?php echo sr_e(sr_t('page::ui.text.a57ab057')); ?></a>
            <a href="<?php echo sr_e(sr_url('/admin/page-groups?status=disabled')); ?>" class="admin-summary-meta"><?php echo sr_e(sr_t('page::ui.text.92cdef3c')); ?> <?php echo sr_e((string) ($pageGroupStatusCounts['disabled'] ?? 0)); ?><?php echo sr_e(sr_t('page::ui.text.a57ab057')); ?></a>
            <a href="<?php echo sr_e(sr_url('/admin/page-groups?status=archived')); ?>" class="admin-summary-meta"><?php echo sr_e(sr_t('page::ui.text.2e4099ba')); ?> <?php echo sr_e((string) ($pageGroupStatusCounts['archived'] ?? 0)); ?><?php echo sr_e(sr_t('page::ui.text.a57ab057')); ?></a>
        </div>
    </div>
    ...
    <form method="get" action="<?php echo sr_e(sr_url('/admin/page-groups')); ?>" class="admin-filter admin-page-group-filter ui-form-theme">
        <div class="admin-filter-grid admin-page-group-search-grid">
            <div class="admin-filter-field">
                <label for="page_admin_groups_status_filter" class="admin-filter-label"><?php echo sr_e(sr_t('page::ui.status.e10195a1')); ?></label>
                <select id="page_admin_groups_status_filter" name="status" class="form-select admin-filter-input">
                    <option value=""<?php echo (string) ($pageGroupFilters['status'] ?? '') === '' ? ' selected' : ''; ?>><?php echo sr_e(sr_t('page::ui.all.a4b69faf')); ?></option>
            ...
            <div class="admin-filter-field">
                <label for="page_admin_groups_field" class="admin-filter-label"><?php echo sr_e(sr_t('page::ui.search.b79bc9c8')); ?></label>
                <select id="page_admin_groups_field" name="field" class="form-select admin-filter-input">
                    <?php foreach (['all' => sr_t('page::ui.all.a4b69faf'), 'key' => 'key', 'title' => sr_t('page::ui.name.253d1510')] as $fieldValue => $fieldLabel) { ?>
            ...
            <div class="admin-filter-field">
                <label for="page_admin_groups_q" class="admin-filter-label"><?php echo sr_e(sr_t('page::ui.search.bda397fc')); ?></label>
                <input id="page_admin_groups_q" type="search" name="q" value="<?php echo sr_e((string) ($pageGroupFilters['q'] ?? '')); ?>" class="form-input admin-filter-input" maxlength="120" placeholder="<?php echo sr_e(sr_t('page::ui.key.name.7852e80c')); ?>">
            </div>
    ...
    <section class="admin-card admin-list-card card admin-list-form">
        ...
        <div class="table-wrapper">
            <table class="table admin-page-group-table">
                <caption class="sr-only"><?php echo sr_e(sr_t('page::ui.page.list.d2ad38e3')); ?></caption>
                <thead class="ui-table-head">
                    <tr>
                        <th><?php echo sr_e(sr_t('page::ui.name.253d1510')); ?></th>
                        <th>Key</th>
                        <th><?php echo sr_e(sr_t('page::ui.status.e10195a1')); ?></th>
                        <th><?php echo sr_e(sr_t('page::ui.page.5ed1a7cd')); ?></th>
                        <th><?php echo sr_e(sr_t('page::ui.text.3788952d')); ?></th>
                ...
                <tbody>
                    <?php if (($pageGroups ?? []) === []) { ?>
                        <tr>
                            <td colspan="7" class="admin-empty-state"><?php echo sr_e(sr_t('page::ui.create.page.02dd9fe3')); ?></td>
                        </tr>
                    <?php } else { ?>
                                ...
                                <td class="admin-table-actions-cell">
                                    <div class="admin-row-actions">
                                        <?php if ((string) ($pageGroup['status'] ?? '') === 'enabled') { ?>
                                            <a href="<?php echo sr_e(sr_url(sr_page_group_path((string) $pageGroup['group_key']))); ?>" class="btn btn-sm btn-solid-light" target="_blank" rel="noopener noreferrer"><?php echo sr_e(sr_t('page::ui.text.ac5b575f')); ?></a>
                                        <?php } ?>
                                        <a href="<?php echo sr_e(sr_url('/admin/page-groups/edit?id=' . rawurlencode((string) $pageGroup['id']))); ?>" class="btn btn-sm btn-solid-light"><?php echo sr_e(sr_t('page::ui.edit.3537f0cc')); ?></a>
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
...
<?php } else { ?>
    <form method="post" action="<?php echo sr_e(sr_url('/admin/page-groups')); ?>" class="admin-form ui-form-theme">
        <section class="admin-card card">
            <h2><?php echo $editing ? sr_t('page::ui.page.edit.700b7706') : sr_t('page::ui.page.5a50b240'); ?></h2>
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_admin_groups_group_key"><?php echo sr_e(sr_t('page::ui.key.1057ecca')); ?><?php echo $editing ? '' : sr_t('page::ui.span.class.sr.required.label.07a9346b'); ?></label>
                <div class="admin-form-field">
                    <?php if ($editing) { ?>
                        <code><?php echo sr_e((string) ($values['group_key'] ?? '')); ?></code>
                    <?php } else { ?>
                        <input id="page_admin_groups_group_key" type="text" name="group_key" value="<?php echo sr_e((string) ($values['group_key'] ?? '')); ?>" class="form-input" maxlength="60" pattern="[a-z0-9_]+" inputmode="latin" autocapitalize="none" spellcheck="false" required data-admin-key-input>
                        <p class="admin-form-help"><?php echo sr_e(sr_t('page::ui.active.bd86f3a1')); ?></p>
                    <?php } ?>
                </div>
            </div>
            <div class="admin-form-row">
                <label class="form-label" for="page_admin_groups_title"><?php echo sr_e(sr_t('page::ui.name.253d1510')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('page::ui.required.1f227c67')); ?></span></label>
                <div class="admin-form-field">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_admin_groups_description"><?php echo sr_e(sr_t('page::ui.text.8c3f651d')); ?></label>
                <div class="admin-form-field">
        ...
        <section class="admin-card card">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_group_layout_key"><?php echo sr_e(sr_t('page::ui.page.fa985852')); ?></label>
                <div class="admin-form-field">
        ...
        <section class="admin-card card">
            <h2><?php echo sr_e(sr_t('page::ui.text.0d968d36')); ?></h2>
                ...
                <div class="admin-form-row">
                    ...
                    <div class="admin-form-field">
                        <select id="<?php echo sr_e('page_group_' . (string) $bannerSettingKey); ?>" name="<?php echo sr_e('group_' . (string) $bannerSettingKey); ?>" class="form-select form-control-full">
                            <option value="0"><?php echo sr_e(sr_t('page::ui.active.4add3230')); ?></option>
        ...
        <section class="admin-card card">
            <h2><?php echo sr_e(sr_t('page::ui.member.4eda7ba7')); ?></h2>
            <div class="admin-form-row">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_group_asset_module"><?php echo sr_e(sr_t('page::ui.text.7d96defe')); ?></label>
                <div class="admin-form-field">
                    <?php echo sr_admin_checkbox_list_html('page_group_asset_module', 'group_asset_module', $assetModuleChoiceOptions, sr_page_asset_module_keys_from_value($groupSettingValue($groupSettings, 'asset_module', 'point')), sr_t('page::ui.text.3e195cdd')); ?>
                    <p class="admin-form-help"><?php echo sr_e($assetDeductionPriorityHelp); ?></p>
                </div>
            </div>
            <div class="admin-form-row">
                <label class="form-label" for="page_group_asset_access_amount"><?php echo sr_e(sr_t('page::ui.text.a9f15a8b')); ?></label>
                <div class="admin-form-field">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_group_asset_charge_policy"><?php echo sr_e(sr_t('page::ui.text.86803f52')); ?></label>
                <div class="admin-form-field">
            ...
            <div class="admin-form-row">
                <span class="form-label"><?php echo sr_e(sr_t('page::ui.active.904d506b')); ?></span>
                <div class="admin-form-field">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_group_asset_action_label"><?php echo sr_e(sr_t('page::ui.text.98fb4605')); ?></label>
                <div class="admin-form-field">
                    <input id="page_group_asset_action_label" type="text" name="group_asset_action_label" value="<?php echo sr_e($groupSettingValue($groupSettings, 'asset_action_label', sr_t('page::ui.text.727333ab'))); ?>" class="form-input" maxlength="80">
                </div>
            </div>
            <div class="admin-form-row">
                <label class="form-label" for="page_group_asset_action_direction"><?php echo sr_e(sr_t('page::ui.text.af7873a8')); ?></label>
                <div class="admin-form-field">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_group_asset_action_module"><?php echo sr_e(sr_t('page::ui.text.2f2b6193')); ?></label>
                <div class="admin-form-field">
                    <?php echo sr_admin_checkbox_list_html('page_group_asset_action_module', 'group_asset_action_module', $assetModuleChoiceOptions, sr_page_asset_module_keys_from_value($groupSettingValue($groupSettings, 'asset_action_module', 'point')), sr_t('page::ui.text.3e195cdd')); ?>
                </div>
            </div>
            <div class="admin-form-row">
                <label class="form-label" for="page_group_asset_action_amount"><?php echo sr_e(sr_t('page::ui.text.5c705e1a')); ?></label>
                <div class="admin-form-field">
            ...
            <h3><?php echo sr_e(sr_t('page::ui.text.b065b16b')); ?></h3>
            <div class="admin-form-row">
                <span class="form-label"><?php echo sr_e(sr_t('page::ui.text.d07eab27')); ?></span>
                <div class="admin-form-field">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_group_file_asset_module"><?php echo sr_e(sr_t('page::ui.text.7d96defe')); ?></label>
                <div class="admin-form-field">
                    <?php echo sr_admin_checkbox_list_html('page_group_file_asset_module', 'group_file_asset_module', $assetModuleChoiceOptions, sr_page_asset_module_keys_from_value($groupSettingValue($groupSettings, 'file_asset_module', 'point')), sr_t('page::ui.text.3e195cdd')); ?>
                    <p class="admin-form-help"><?php echo sr_e($assetDeductionPriorityHelp); ?></p>
                </div>
            </div>
            <div class="admin-form-row">
                <label class="form-label" for="page_group_file_asset_download_amount"><?php echo sr_e(sr_t('page::ui.text.a9f15a8b')); ?></label>
                <div class="admin-form-field">
            ...
            <div class="admin-form-row">
                <label class="form-label" for="page_group_file_asset_charge_policy"><?php echo sr_e(sr_t('page::ui.text.86803f52')); ?></label>
                <div class="admin-form-field">
        ...
        <div class="admin-form-sticky-actions admin-form-actions admin-form-actions-split">
            <a href="<?php echo sr_e(sr_url('/admin/page-groups')); ?>" class="btn btn-solid-light"><?php echo sr_e(sr_t('page::ui.list.f07b3200')); ?></a>
