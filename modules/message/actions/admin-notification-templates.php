...
sr_admin_require_permission($pdo, (int) $account['id'], '/admin/message/notification-templates', 'view');
if (sr_request_method() === 'POST') {
    sr_require_csrf();
    sr_admin_require_permission($pdo, (int) $account['id'], '/admin/message/notification-templates', 'edit');
}

sr_message_ensure_notification_templates($pdo);
sr_notification_event_template_admin_handle($pdo, $site ?? null, [
    'module_key' => 'message',
    'permission_path' => '/admin/message/notification-templates',
    'return_path' => '/admin/message/notification-templates',
    'title' => '쪽지 알림/메일 관리',
]);
