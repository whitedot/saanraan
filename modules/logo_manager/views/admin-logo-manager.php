...
<section class="admin-card card logo-manager-current">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-outline-secondary" aria-haspopup="dialog" aria-expanded="false" aria-controls="logo-manager-upload-modal" data-overlay="#logo-manager-upload-modal"><?php echo sr_e(sr_t('logo_manager::ui.default.upload.04ff420c')); ?></button>
    </div>
    <div class="card-body logo-manager-current-grid">
        <?php foreach ($defaultUsageOptions as $usageKey => $usageOption) { ?>
            <?php $active = is_array($activeAssignments[$usageKey] ?? null) ? $activeAssignments[$usageKey] : null; ?>
            <?php $default = is_array($defaultAssignments[$usageKey] ?? null) ? $defaultAssignments[$usageKey] : null; ?>
            <article class="logo-manager-current-item">
                ...
                <?php } ?>
                <?php if ($default !== null && $active !== null && (int) ($default['assignment_id'] ?? 0) !== (int) ($active['assignment_id'] ?? 0)) { ?>
                    <small><?php echo sr_e(sr_t('logo_manager::ui.default.current.5d57e61e')); ?>: <?php echo sr_e((string) ($default['title'] ?? '')); ?></small>
                <?php } ?>
            </article>
        <?php } ?>
    </div>
    ...
    <div class="modal-dialog modal-dialog-lg">
        <form method="post" action="<?php echo sr_e(sr_url('/admin/logo-manager')); ?>" enctype="multipart/form-data" class="modal-content ui-form-theme">
            <div class="modal-header">
                <h3 id="logo-manager-upload-modal-label" class="modal-title"><?php echo sr_e(sr_t('logo_manager::ui.default.upload.04ff420c')); ?></h3>
            ...
            <div class="modal-body">
                <p class="admin-dashboard-meta"><?php echo sr_e(sr_t('logo_manager::ui.default.help.b98a3c98')); ?></p>
                <?php echo sr_csrf_field(); ?>
                <input type="hidden" name="intent" value="upload_default_logo">
                <div class="admin-form-row">
                    ...
                    <div class="admin-form-field">
                        ...
                        <small class="admin-form-help"><?php echo sr_e(sr_t('logo_manager::ui.default.usage.help.22392299')); ?></small>
                    </div>
                </div>
                <div class="admin-form-row">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-solid-primary modal-action"><?php echo sr_e(sr_t('logo_manager::ui.default.save.27528959')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<div id="logo-manager-assignment-modal" class="modal-overlay modal-overlay-fade overlay hidden pointer-events-none opacity-0" role="dialog" tabindex="-1" aria-labelledby="logo-manager-assignment-modal-label" aria-hidden="true" inert>
    <div class="modal-dialog modal-dialog-lg">
        <form method="post" action="<?php echo sr_e(sr_url('/admin/logo-manager')); ?>" enctype="multipart/form-data" class="modal-content ui-form-theme">
            <div class="modal-header">
                <h3 id="logo-manager-assignment-modal-label" class="modal-title"><?php echo sr_e(sr_t('logo_manager::ui.event.add.b78b6c5d')); ?></h3>
            ...
            <div class="modal-body">
                ...
                <?php echo sr_csrf_field(); ?>
                <input type="hidden" name="intent" value="upload_event_logo">
                <div class="admin-form-row">
                    ...
                    <div class="admin-form-field">
                        <select id="logo_manager_assignment_usage" name="usage_key" class="form-select" data-overlay-focus>
                ...
                <div class="admin-form-row">
                    <label class="form-label" for="logo_manager_assignment_title"><?php echo sr_e(sr_t('logo_manager::ui.name.2b2c54b5')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('logo_manager::ui.required.1f227c67')); ?></span></label>
                    <div class="admin-form-field">
                        <input id="logo_manager_assignment_title" type="text" name="title" class="form-input form-control-full" maxlength="120" required>
                    </div>
                </div>
                <div class="admin-form-row">
                ...
                <div class="admin-form-row">
                    <label class="form-label" for="logo_manager_assignment_logo_file"><?php echo sr_e(sr_t('logo_manager::ui.text.4becf8bb')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('logo_manager::ui.required.1f227c67')); ?></span></label>
                    <div class="admin-form-field">
                        <input id="logo_manager_assignment_logo_file" type="file" name="logo_file" accept="image/jpeg,image/png,image/webp,image/svg+xml,.svg" class="form-input" required>
                        <small class="admin-form-help"><?php echo sr_e(sr_t('logo_manager::ui.1.save.save.cfcc4930')); ?></small>
                    </div>
                </div>
                <div class="admin-form-row">
                    ...
                    <div class="admin-form-field">
                        ...
                        <small class="admin-form-help"><?php echo sr_e(sr_t('logo_manager::ui.event.period.help.741651e0')); ?></small>
                    </div>
                </div>
                <div class="admin-form-row">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-solid-primary modal-action"><?php echo sr_e(sr_t('logo_manager::ui.event.save.91d77975')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<section class="admin-card admin-list-card card admin-list-form">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-outline-secondary" aria-haspopup="dialog" aria-expanded="false" aria-controls="logo-manager-assignment-modal" data-overlay="#logo-manager-assignment-modal"><?php echo sr_e(sr_t('logo_manager::ui.event.add.b78b6c5d')); ?></button>
    </div>
    <div class="admin-list-summary-row">
        <?php if (empty($assignmentSort['is_default'])) { ?>
            <a href="<?php echo sr_e(sr_admin_sort_url($assignmentSortOptions, $assignmentDefaultSort, '', '', 'assignment_sort', 'assignment_dir', 'assignment_page')); ?>" class="btn btn-sm btn-icon btn-outline-danger admin-sort-reset" aria-label="이벤트 로고 목록 기본 정렬로 초기화" title="기본 정렬로 초기화"><?php echo sr_material_icon_html('restart_alt'); ?></a>
        <?php } ?>
        <?php echo sr_admin_pagination_summary_html($assignmentPagination); ?>
    </div>
    <div class="table-wrapper">
        <table class="table logo-manager-assignments-table">
            <caption class="sr-only"><?php echo sr_e(sr_t('logo_manager::ui.event.list.2c086af7')); ?></caption>
...
<?php echo sr_admin_pagination_html($assignmentPagination, '이벤트 로고 목록 페이지'); ?>
