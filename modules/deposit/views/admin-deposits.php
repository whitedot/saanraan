...
<form method="get" action="<?php echo sr_e(sr_url($depositAdminPage === 'transactions' ? '/admin/deposits/transactions' : '/admin/deposits/balances')); ?>" class="admin-filter admin-asset-member-filter ui-form-theme">
    <div class="admin-filter-grid admin-asset-member-search-grid">
        <div class="admin-filter-field">
            <label for="deposit-member-search-field" class="admin-filter-label"><?php echo sr_e(sr_t('deposit::ui.search.b79bc9c8')); ?></label>
        ...
        <div class="admin-filter-field admin-asset-member-filter-keyword">
            <label for="deposit-member-search-keyword" class="admin-filter-label"><?php echo sr_e(sr_t('deposit::ui.search.bda397fc')); ?></label>
            <input type="text" id="deposit-member-search-keyword" name="q" value="<?php echo sr_e((string) ($accountLookupFilter['keyword'] ?? '')); ?>" class="form-input admin-filter-input" maxlength="120" placeholder="<?php echo sr_e(sr_t('deposit::ui.email.login.name.c26ba637')); ?>">
        </div>
        <button type="submit" class="btn btn-solid-primary admin-filter-submit"><?php echo sr_e(sr_t('deposit::ui.search.4b8d541e')); ?></button>
    </div>
</form>
...
<?php } else { ?>
    <section class="admin-card admin-list-card card admin-list-form">
        ...
        <table class="table">
            <thead class="ui-table-head">
                <tr>
                    <th><?php echo sr_e(sr_t('deposit::ui.member.900e04a5')); ?></th>
                    <th><?php echo sr_e(sr_t('deposit::ui.member.e335b899')); ?></th>
                        ...
                        <tr>
                            ...
                            <td class="admin-table-actions-cell">
                                <div class="admin-row-actions">
                                    ...
                                    <a href="<?php echo sr_e(sr_url('/admin/deposits/balances?account_identifier=' . rawurlencode((string) $balance['account_public_hash']))); ?>" class="btn btn-sm btn-solid-light" aria-haspopup="dialog" aria-expanded="false" aria-controls="<?php echo sr_e($depositBalanceAdjustModalId); ?>" data-overlay="#<?php echo sr_e($depositBalanceAdjustModalId); ?>"><?php echo sr_e(sr_t('deposit::ui.text.b9d9b240')); ?></a>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <div class="modal-dialog">
                <form method="post" action="<?php echo sr_e(sr_url('/admin/deposits/balances' . ((string) $depositAdjustModalAccount['account_public_hash'] !== '' ? '?account_identifier=' . rawurlencode((string) $depositAdjustModalAccount['account_public_hash']) : ''))); ?>" class="modal-content ui-form-theme">
                    ...
                    <div class="modal-body">
                        ...
                        <?php } ?>
                        <div class="admin-form-row">
                            <label class="form-label" for="<?php echo sr_e($depositAdjustFieldPrefix); ?>_transaction_type"><?php echo sr_e(sr_t('deposit::ui.text.3a7bc5ac')); ?></label>
                            <div class="admin-form-field">
                        ...
                        <div class="admin-form-row">
                            <label class="form-label" for="<?php echo sr_e($depositAdjustReferenceTypeInputId); ?>"><?php echo sr_e(sr_t('deposit::ui.text.200e7df1')); ?></label>
                            <div class="admin-form-field">
                        ...
                        <div class="admin-form-row">
                            <label class="form-label" for="<?php echo sr_e($depositAdjustReferenceIdInputId); ?>"><?php echo sr_e(sr_t('deposit::ui.id.e89e337e')); ?></label>
                            <div class="admin-form-field">
                                <div class="admin-lookup-control">
            ...
            <div class="modal-dialog">
                <form method="post" action="<?php echo sr_e(sr_url('/admin/deposits/transactions?account_identifier=' . rawurlencode((string) $depositRefundTransaction['account_public_hash']))); ?>" class="modal-content ui-form-theme">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="admin-summary-stats">
                            <span class="admin-summary-meta"><?php echo sr_e(sr_t('deposit::ui.text.da1026da')); ?> <strong>#<?php echo sr_e((string) $depositRefundTransactionId); ?></strong></span>
