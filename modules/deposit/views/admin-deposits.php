...
<form method="get" action="<?php echo sr_e(sr_url($depositAdminPage === 'transactions' ? '/admin/deposits/transactions' : '/admin/deposits/balances')); ?>" class="filtering-form filtering filtering-plain admin-asset-member-filter ui-form-theme">
    <div class="filtering-fields admin-asset-member-search-grid">
        <div class="filtering-field">
            <label for="deposit-member-search-field" class="filtering-label">검색조건</label>
            <select name="field" id="deposit-member-search-field" class="form-select filtering-input">
        ...
        <div class="filtering-field admin-asset-member-filter-keyword">
            <label for="deposit-member-search-keyword" class="filtering-label"><?php echo sr_e(sr_t('deposit::ui.search.bda397fc')); ?></label>
            <input type="text" id="deposit-member-search-keyword" name="q" value="<?php echo sr_e((string) ($accountLookupFilter['keyword'] ?? '')); ?>" class="form-input filtering-input" maxlength="120" placeholder="<?php echo sr_e(sr_t('deposit::ui.email.login.name.c26ba637')); ?>">
        </div>
        <button type="submit" class="btn btn-solid-primary filtering-submit"><?php echo sr_e(sr_t('deposit::ui.search.4b8d541e')); ?></button>
    </div>
</form>
...
<?php if ($depositAdminPage === 'transactions') { ?>
    <section class="card admin-list-card admin-list-form">
        ...
        <div class="admin-icon-button-legend" aria-label="아이콘 버튼 설명">
            <span class="admin-icon-button-legend-item"><?php echo sr_material_icon_html('edit'); ?> <?php echo sr_e(sr_t('deposit::ui.text.b9d9b240')); ?></span>
        </div>
	    </section>
    ...
    <section class="card admin-list-card admin-list-form">
        ...
        <table class="table table-list admin-asset-balance-table">
            ...
            <tbody>
                <?php if ($balances === []) { ?>
                    <tr>
                        <td colspan="5" class="admin-empty-state"><?php echo sr_e(sr_t('deposit::ui.deposit.6d4d4d20')); ?></td>
                    </tr>
                <?php } else { ?>
                    <?php foreach ($balances as $balance) { ?>
                        <tr>
                            ...
                            <td><?php echo sr_deposit_time_html((string) $balance['updated_at']); ?></td>
                            <td class="admin-table-actions-cell">
                                <div class="admin-row-actions">
            ...
            <div class="modal-dialog">
                <form method="post" action="<?php echo sr_e(sr_url('/admin/deposits/balances' . ((string) $depositAdjustModalAccount['account_public_hash'] !== '' ? '?account_identifier=' . rawurlencode((string) $depositAdjustModalAccount['account_public_hash']) : ''))); ?>" class="modal-content ui-form-theme">
                    ...
                    <div class="modal-body">
                        ...
                        <?php } else { ?>
                            <div class="form-row">
                                <?php echo sr_admin_form_label_help_html($depositAdjustAccountInputId, sr_t('deposit::ui.member.900e04a5'), $depositHelp['member_hash']['id'], $depositHelpOpenLabel, true, true); ?>
                        ...
                        <?php } ?>
                        <div class="form-row">
                            <?php echo sr_admin_form_label_help_html($depositAdjustFieldPrefix . '_transaction_type', sr_t('deposit::ui.text.3a7bc5ac'), $depositHelp['transaction_type']['id'], $depositHelpOpenLabel, true, true); ?>
                            <div class="form-field">
                        ...
                        <div class="form-row">
                            <?php echo sr_admin_form_label_help_html($depositAdjustFieldPrefix . '_amount', sr_t('deposit::ui.text.5c705e1a'), $depositHelp['amount']['id'], $depositHelpOpenLabel, true, true); ?>
                            <div class="form-field">
                                ...
                                <p class="form-help"><?php echo sr_e(sr_t('deposit::ui.active.2db1fd9d')); ?></p>
                            </div>
                        </div>
                        <div class="form-row">
                            <?php echo sr_admin_form_label_help_html($depositAdjustFieldPrefix . '_reason', sr_t('deposit::ui.text.ab9442a2'), $depositHelp['reason']['id'], $depositHelpOpenLabel, true, true); ?>
                            <div class="form-field">
            ...
            <div class="modal-dialog">
                <form method="post" action="<?php echo sr_e(sr_url('/admin/deposits/transactions?account_identifier=' . rawurlencode((string) $depositRefundTransaction['account_public_hash']))); ?>" class="modal-content ui-form-theme">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <?php echo sr_admin_form_label_help_html($depositRefundFieldPrefix . '_amount', sr_t('deposit::ui.text.a27af6c4'), $depositHelp['refund_amount']['id'], $depositHelpOpenLabel, true, true); ?>
                            <div class="form-field">
                                ...
                                <p class="form-help"><?php echo sr_e(sr_t('deposit::ui.deposit.save.4f951908')); ?></p>
                            </div>
                        </div>
                        <div class="form-row">
                            <?php echo sr_admin_form_label_help_html($depositRefundFieldPrefix . '_reason', sr_t('deposit::ui.text.ab9442a2'), $depositHelp['refund_reason']['id'], $depositHelpOpenLabel, true, true); ?>
                            <div class="form-field">
                                ...
                                <p class="form-help"><?php echo sr_e(sr_t('deposit::ui.id.0b5dbcb4')); ?> <?php echo sr_e($depositRefundReferenceId); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
