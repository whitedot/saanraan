...
<p>
    <a href="<?php echo sr_e(sr_url('/admin/deposits/balances')); ?>">잔액</a>
    |
    <a href="<?php echo sr_e(sr_url('/admin/deposits/adjust')); ?>">조정</a>
    |
    <a href="<?php echo sr_e(sr_url('/admin/deposits/transactions')); ?>">거래 내역</a>
</p>
