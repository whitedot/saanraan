...
async function renderContentSidebar(page, scheme, width) {
  ...
  await page.setContent(`<!doctype html><html data-color-scheme="${scheme}"><head><style>:root{${tokens}}</style></head><body><main class="content-page content-page-view"><div class="content-screen-frame"><div class="content-screen-main"><article class="content-article"><div class="content-reading-panel"><header class="content-header"><h1>콘텐츠 제목</h1><div class="content-meta"><span>작성자</span><span>방금 전</span></div><div class="content-view-actions"><div class="content-view-action-group content-view-action-group-trailing"><a class="btn btn-sm btn-outline-default content-edit-link" href="#">수정</a></div></div></header><div class="content-body">읽기 본문</div><div class="reaction-widget">반응</div><div class="content-view-actions content-view-actions-bottom"><div class="content-view-action-group content-view-action-group-trailing"><a class="btn btn-sm btn-outline-default content-edit-link" href="#">수정</a></div></div></div><section class="content-comments"><div class="content-comments-panel-header"><h2>댓글</h2></div><ul><li class="content-comment-item"><div class="content-comment-body">댓글 본문</div></li></ul></section></article></div><aside class="content-sidebar"><section class="card content-sidebar-section"><div class="card-body"><ul class="content-sidebar-list content-sidebar-comment-list"><li><a href="#">최신 댓글 본문</a><span class="content-sidebar-comment-meta"><span class="content-sidebar-comment-byline"><span>관리자</span><span aria-hidden="true">·</span><time>17시간 전</time></span><span class="content-sidebar-comment-separator" aria-hidden="true">·</span><a class="content-sidebar-comment-content" href="#">아주 긴 원본 콘텐츠 제목입니다</a></span></li></ul></div></section></aside></div></main></body></html>`);
