...
const issueRoutes = {
  ...
  184: ['/admin/content', '/admin/content/new', '/admin/content/series', '/admin/content/settings', '/admin/content/files', '/admin/content/link-card-targets?target=community_post&q=test', '/admin/content/link-refs', '/admin/content/file-downloads', '/admin/content/asset-policy-sets', '/admin/content-groups', '/admin/content-groups/new'],
  185: ['/admin/community/settings', '/admin/community/asset-policy-sets', '/admin/community/levels', '/admin/community/boards', '/admin/community/boards/new', '/admin/community/board-groups', '/admin/community/board-groups/new', '/admin/community/posts', '/admin/community/comments', '/admin/community/link-refs', '/admin/community/reports', '/admin/community/series'],
