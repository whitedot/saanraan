...
$riskGateMarkers = [
    ...
    'R-03 공유호스팅 queue/cron/배치' => ['ops-status.php', 'expire-points.php --dry-run', '/admin/operations', '지연/실패 row 확인'],
    'R-04 개인정보 export/cleanup 계약' => ['privacy matrix', 'export/cleanup smoke', '운영 보존 데이터 검토'],
    'R-05 넓은 번들 모듈 표면' => ['module status', 'check-module-status.php', 'release-installed-gate-status.php', 'asset_ledger/point/coupon/community/quiz/privacy/ckeditor', 'beta smoke 기록', '등급 상향 근거'],
