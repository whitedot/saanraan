...
$expectedRows = [
    'R-01' => ['mitigating', [
        ...
        '자산/쿠폰/유료 접근권 mutation smoke readiness 게이트',
    ...
    'R-02' => ['mitigating', [
        ...
        '브라우저 asset 로딩',
        'CKEditor',
        'CKEditor upload/save browser smoke readiness 게이트',
        '저장 HTML sanitizer',
    ]],
    ...
    'R-04' => ['mitigating', [
        ...
        '.tools/bin/release-installed-gate-status.php',
        '개인정보 export/cleanup smoke readiness 게이트',
        'export_retained',
        '고위험 필드',
        '보존기간 정책',
        '릴리스 차단',
    ...
    'R-05' => ['mitigating', [
        ...
        '.tools/bin/check-module-status.php',
        '.tools/bin/release-installed-gate-status.php',
        'asset_ledger',
        'point',
        'coupon',
