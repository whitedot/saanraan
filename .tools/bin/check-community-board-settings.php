...
sr_check_community_board_settings_contains('modules/community/views/admin-settings.php', [
    ...
    'sr_community_board_sidebar_menu_type_options($communityBoardSidebarSiteMenuAvailable)',
    'sr_admin_module_reference_list_html($pdo, $communitySiteMenuModuleReferences)',
...
sr_check_community_board_settings_contains('modules/community/views/admin-settings.php', [
    'sr_admin_module_reference_list_html($pdo, $communityLayoutModuleReferences)',
    'sr_admin_module_reference_list_html($pdo, $communitySiteMenuModuleReferences)',
    'sr_admin_module_reference_list_html($pdo, $communityEditorModuleReferences)',
    'sr_admin_module_reference_list_html($pdo, $communityToolbarModuleReferences)',
    'sr_admin_module_reference_list_html($pdo, $communityInternalEmbedModuleReferences)',
...
sr_check_community_board_settings_contains('modules/admin/assets/admin.css', [
    '.admin-form .form-field .form-help{margin-top:calc(var(--spacing) * 2);color:var(--text-muted);font-size:var(--text-xs);line-height:var(--text-xs--line-height)}',
