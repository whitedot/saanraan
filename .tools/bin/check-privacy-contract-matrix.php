...
$expected = [
    ...
    'deposit' => ['status' => 'export_retained', 'export' => true, 'cleanup' => true],
    ...
    'message' => ['status' => 'export_cleanup', 'export' => true, 'cleanup' => true],
    ...
    'identity_verification' => ['status' => 'export_cleanup', 'export' => true, 'cleanup' => true],
    'identity_kcp' => ['status' => 'no_member_personal_data', 'export' => false, 'cleanup' => false],
    'identity_inicis' => ['status' => 'no_member_personal_data', 'export' => false, 'cleanup' => false],
    'notification' => ['status' => 'export_retained', 'export' => true, 'cleanup' => true],
    'payment_ledger' => ['status' => 'export_cleanup', 'export' => true, 'cleanup' => true],
...
foreach ([
    ...
    ['needle' => "author_public_name_snapshot = ''", 'file' => 'modules/content/helpers/comments.php'],
    ['needle' => "author_public_name_snapshot = ''", 'file' => 'modules/community/helpers/posts-comments.php'],
    ...
    ['needle' => 'sr_privacy_cleanup_runtime_check_deposit', 'file' => '.tools/bin/check-privacy-cleanup-runtime.php'],
    ['needle' => 'sr_privacy_cleanup_runtime_check_reward', 'file' => '.tools/bin/check-privacy-cleanup-runtime.php'],
...
foreach ([
    ...
    'check-policy-documents-runtime.php',
    'check-member-oauth-runtime.php',
    'check-notification-runtime.php',
    'check-doc-links.php',
