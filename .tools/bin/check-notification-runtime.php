...
sr_notification_runtime_assert(
    str_contains($settingsView, 'Slack 회원 연결 허용')
        && str_contains($settingsView, 'Discord 회원 연결 허용')
        && str_contains($settingsView, 'Telegram 회원 연결 허용')
        && !str_contains($settingsView, '회원 수신처 허용'),
