...
if (!is_string($adminVerificationsAction) || !is_string($adminVerificationsView) || !is_string($adminVerificationsCss)) {
    ...
    || !str_contains($adminVerificationsView, 'badge-status <?php echo sr_e(sr_identity_verification_attempt_status_class($attemptStatus)); ?>')
    ...
    || !str_contains($adminVerificationsCss, '.identity-verification-detail-summary .badge-status')
    || !str_contains($adminVerificationsCss, '.identity-verification-admin-verifications .modal-body .badge-status.is-success')
    || !str_contains($adminVerificationsCss, '.identity-verification-admin-verifications .modal-body .badge-status.is-danger')
