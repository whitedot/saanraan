...
$expectedEvidenceMarkers = [
    ...
    'point' => ['check-asset-reconciliation.php', 'check-asset-settlement-contract.php'],
    ...
    'embed_manager' => ['check-embed-manager-contracts.php', 'refs sync runtime fixture', 'private/broken 렌더링 fixture'],
