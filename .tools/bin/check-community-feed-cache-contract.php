...
function sr_check_community_feed_cache_contract_home_feed_fixture(): void
{
    ...
    $pdo->exec('CREATE TABLE sr_community_hidden_targets (
        id INTEGER PRIMARY KEY,
...
sr_check_community_feed_cache_contract_contains('modules/community/helpers/presentation.php', [
    ...
    'function sr_community_home_latest_post_sections_from_board_posts',
    'function sr_community_home_latest_post_sections',
...
sr_check_community_feed_cache_contract_contains('modules/community/actions/home.php', [
