...
sr_community_release_file_contains('modules/community/theme/basic/post.php', [
    ...
    'class="community-comment-meta-item community-comment-date"',
    'class="community-comment-permalink"',
    'sr_community_time_html($communityCommentCreatedAt)',
    "sr_material_icon_html('link')",
