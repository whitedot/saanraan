...
$checks = [
    ...
    [
        'label' => 'admin point notification templates entry',
        'path' => '/admin/points/notification-templates',
        'allowed_statuses' => [200, 302, 403, 404],
        'must_not_contain' => ['Fatal error', 'Stack trace'],
    ],
    [
        'label' => 'admin reward notification templates entry',
        'path' => '/admin/rewards/notification-templates',
        'allowed_statuses' => [200, 302, 403, 404],
        'must_not_contain' => ['Fatal error', 'Stack trace'],
    ],
    [
        'label' => 'admin deposit notification templates entry',
        'path' => '/admin/deposits/notification-templates',
        'allowed_statuses' => [200, 302, 403, 404],
        'must_not_contain' => ['Fatal error', 'Stack trace'],
    ],
    [
        'label' => 'admin coupon notification templates entry',
        'path' => '/admin/coupons/notification-templates',
        'allowed_statuses' => [200, 302, 403, 404],
        'must_not_contain' => ['Fatal error', 'Stack trace'],
    ],
    [
        'label' => 'admin content notification templates entry',
    ...
    [
        'label' => 'admin reaction notification templates entry',
