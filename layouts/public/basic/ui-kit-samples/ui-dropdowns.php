...
<div class="container-fluid">
                    <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-xl-2 ui-kit-gap-base">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.menu.active.99b41e46')); ?></p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.text.eab18637')); ?></p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.text.4aa7ed8f')); ?></p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.menu.active.3ed4e224')); ?></p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.menu.5548d650')); ?></p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.menu.menu.8e3b133d')); ?>
                                </p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.menu.active.menu.d08ffdf3')); ?></p>
                                <div class="dropdown" data-dropdown-placement="bottom-end">
                                    <button type="button"
                                        class="dropdown-toggle btn btn-solid-primary"
                                        aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-wide dropdown-menu-padded" role="menu" aria-orientation="vertical">
                                        <span class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.menu.ab99a84e')); ?></span>
                                        <p class="ui-kit-ink-default-400"><?php echo sr_e(sr_t('ui.text.f96634d5')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.menu.menu.active.deecc2cd')); ?></p>
                                <div class="ui-kit-cluster ui-kit-wrap ui-kit-align-items-center ui-kit-gap-2-5">
                                    <div
