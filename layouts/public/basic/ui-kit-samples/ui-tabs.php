                    ...
                    <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-xl-2 ui-kit-gap-base">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.default.tabs.9fc5b992')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.text.76d77ea3')); ?></p>
                                <div>
                                    <nav class="tab-nav" aria-label="Tabs" role="tablist"
                                        ...
                                        <button type="button"
                                            ...
                                            <?php echo sr_e(sr_t('ui.text.d4b47a5c')); ?>
                                        </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <?php echo sr_e(sr_t('ui.settings.115bced4')); ?>
                                        </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <?php echo sr_e(sr_t('ui.text.9fd8413e')); ?>
                                        </button>
                                    </nav>
                                </div>
                                ...
                                <div class="tab-panel-space">
                                    ...
                                    <div id="default-activity" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="activity">
                                        <p><?php echo sr_e(sr_t('ui.all.status.notification.status.b3013a7d')); ?></p>
                                    </div>

                                    <div id="default-settings" class="ui-kit-state-hidden" role="tabpanel"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.tabs.justified.6504c838')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.active.all.all.d71866ef')); ?></p>
                                ...
                                <div>
                                    <nav class="tab-nav-justified" aria-label="Tabs" role="tablist"
                                        ...
                                        <button type="button"
                                            ...
                                            <?php echo sr_e(sr_t('ui.text.f05481be')); ?>
                                        </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <?php echo sr_e(sr_t('ui.text.0e7cfc63')); ?>
                                        </button>
                                    </nav>
                                </div>
                                ...
                                <div class="tab-panel-space">
                                    ...
                                    <div id="profile1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="profile-1">
                                        <p><?php echo sr_e(sr_t('ui.settings.password.settings.3cf58eeb')); ?></p>
                                    </div>

                                    <div id="settings1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="settings-1">
                                        <p><?php echo sr_e(sr_t('ui.settings.notification.settings.6ae8f9f3')); ?></p>
                                    </div>

                                    <div id="projects1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="projects-1">
                                        <p><?php echo sr_e(sr_t('ui.text.6b7a6f12')); ?></p>
                                    </div>

                                    <div id="Support1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="Support-1">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.text.9d8322f6')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.flex.1ff5c66c')); ?></p>
                                ...
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-md-4 ui-kit-gap-base">
                                    ...
                                    <div class="ui-kit-column-md-3">
                                        <div id="v-pills-home-tab" role="tabpanel" aria-labelledby="vertical-overview">
                                            <p class="ui-kit-space-after-2"><?php echo sr_e(sr_t('ui.dashboard.9a160551')); ?></p>
                                            <ul class="ui-kit-space-after-4 ui-kit-list-disc ui-kit-stack-1 ui-kit-start-pad-8">
                                                <li><?php echo sr_e(sr_t('ui.all.status.bf90fe33')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.8dedca4e')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.c50f9982')); ?></li>
                                            </ul>
                                            <p><?php echo sr_e(sr_t('ui.dashboard.2e6e72bc')); ?></p>
                                        </div>

                                        <div id="v-pills-profile-tab" class="ui-kit-state-hidden" role="tabpanel"
                                            aria-labelledby="vertical-activity">
                                            <p class="ui-kit-space-after-2"><?php echo sr_e(sr_t('ui.text.f2a801b9')); ?></p>
                                            <ul class="ui-kit-space-after-4 ui-kit-list-disc ui-kit-stack-1 ui-kit-start-pad-8">
                                                <li><?php echo sr_e(sr_t('ui.name.email.95480bf4')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.password.bf1d4719')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.98b83b01')); ?></li>
                                            </ul>
                                            <p><?php echo sr_e(sr_t('ui.status.0577e68a')); ?></p>
                                        </div>

                                        <div id="v-pills-settings-tab" class="ui-kit-state-hidden" role="tabpanel"
                                            ...
                                            <ul class="ui-kit-space-after-4 ui-kit-list-disc ui-kit-stack-1 ui-kit-start-pad-8">
                                                <li><?php echo sr_e(sr_t('ui.select.2b63f28a')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.email.notification.e0391734')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.d155b96c')); ?></li>
                                            </ul>
                                            <p><?php echo sr_e(sr_t('ui.settings.5e4833a3')); ?></p>
                                        </div>

                                        <div id="v-pills-projects-tab" class="ui-kit-state-hidden" role="tabpanel"
                                            aria-labelledby="vertical-disabled">
                                            <p class="ui-kit-space-after-2"><?php echo sr_e(sr_t('ui.text.81672289')); ?></p>
                                            <ul class="ui-kit-space-after-4 ui-kit-list-disc ui-kit-stack-1 ui-kit-start-pad-8">
                                                <li><?php echo sr_e(sr_t('ui.text.e41fb787')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.1d692400')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.25e193b8')); ?></li>
                                            </ul>
                                            <p><?php echo sr_e(sr_t('ui.active.0bf30f64')); ?></p>
                                        </div>

                                        <div id="v-pills-support-tab" class="ui-kit-state-hidden" role="tabpanel"
                                            aria-labelledby="vertical-support">
                                            <p class="ui-kit-space-after-2"><?php echo sr_e(sr_t('ui.text.299130dd')); ?></p>
                                            <ul class="ui-kit-space-after-4 ui-kit-list-disc ui-kit-stack-1 ui-kit-start-pad-8">
                                                <li><?php echo sr_e(sr_t('ui.text.950ef2ef')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.e72037d3')); ?></li>
                                                <li><?php echo sr_e(sr_t('ui.text.4dc94e7e')); ?></li>
                                            </ul>
                                            <p><?php echo sr_e(sr_t('ui.text.745e026d')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card-body-->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.pills.a7b47b14')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.pill.status.58fdd3c1')); ?></p>
                                ...
                                <div class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-md-4 ui-kit-gap-base">
                                    <div class="ui-kit-column-md-3">
                                        ...
                                        <div id="v-pills-profile-right" class="ui-kit-state-hidden" role="tabpanel"
                                        ...
                                        <div id="v-pills-settings-right" class="ui-kit-state-hidden" role="tabpanel"
                                        ...
                                        <div id="v-pills-projects-right" class="ui-kit-state-hidden" role="tabpanel"
                                        ...
                                        <div id="v-pills-support-right" class="ui-kit-state-hidden" role="tabpanel"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.tabs.bordered.1cd533a1')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.status.55c3c3ba')); ?></p>
                                ...
                                <div>
                                    <nav class="tab-nav-bordered" aria-label="Tabs"
                                        ...
                                        <button type="button"
                                            ...
                                            <?php echo sr_e(sr_t('ui.text.034999fa')); ?>
                                        </button>
                                        ...
                                        <button type="button"
                                            ...
                                            <?php echo sr_e(sr_t('ui.text.b8cf07ac')); ?>
                                        </button>
                                    </nav>
                                </div>
                                ...
                                <div class="tab-panel-space">
                                    ...
                                    <div id="profile-b1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="profile-border">
                                        <p><?php echo sr_e(sr_t('ui.text.0a90fdd6')); ?></p>
                                    </div>

                                    <div id="settings-b1" class="ui-kit-state-hidden" role="tabpanel"
                                        aria-labelledby="settings-border">
                                        <p><?php echo sr_e(sr_t('ui.text.a9441910')); ?></p>
                                    </div>

                                    <div id="about-b1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="about-border">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.tabs.with.colored.border.dfdbfa28')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.select.active.26177deb')); ?></p>
                                ...
                                <div class="tab-panel-space">
                                    ...
                                    <div id="profile-ib1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="profile-icon">
                                        <p><?php echo sr_e(sr_t('ui.text.d0eb5a5a')); ?></p>
                                    </div>

                                    <div id="settings-ib1" class="ui-kit-state-hidden" role="tabpanel"
                                        aria-labelledby="settings-icon">
                                        <p><?php echo sr_e(sr_t('ui.text.63a0eaba')); ?></p>
                                    </div>

                                    <div id="about-ib1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="about-icon">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo sr_e(sr_t('ui.icons.tabs.d011b88f')); ?></h4>
                            </div>

                            <div class="card-body">
                                <p class="ui-kit-ink-default-400 ui-kit-space-after-4"><?php echo sr_e(sr_t('ui.status.active.700c0ef0')); ?></p>
                                ...
                                <div class="tab-panel-space">
                                    ...
                                    <div id="profile-i1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="profile-icon-2">
                                        <p><?php echo sr_e(sr_t('ui.text.efb948b4')); ?></p>
                                    </div>

                                    <div id="settings-i1" class="ui-kit-state-hidden" role="tabpanel"
                                        aria-labelledby="settings-icon-2">
                                        <p><?php echo sr_e(sr_t('ui.text.db8f5867')); ?></p>
                                    </div>

                                    <div id="about-i1" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="about-icon-2">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div id="profile-ct" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="accounts">
                                        <p><?php echo sr_e(sr_t('ui.text.924c7ec3')); ?></p>
                                    </div>

                                    <div id="settings-ct" class="ui-kit-state-hidden" role="tabpanel" aria-labelledby="setting">
