                                ...
                                <form id="customValidationForm" class="ui-kit-grid ui-kit-grid-md-12 ui-kit-grid-1 ui-kit-gap-base"
                                    ...
                                    <div class="ui-kit-column-md-12">
                                        <div class="ui-kit-cluster ui-kit-wrap ui-kit-align-items-center">
                                            ...
                                            <p class="invalid-msg ui-kit-space-before-2 ui-kit-state-hidden ui-kit-fill-width ui-kit-type-sm ui-kit-ink-danger"><?php echo sr_e(sr_t('ui.text.6d48c575')); ?></p>
                                        </div>
                                    </div>
                                ...
                                <form id="serverForm" class="ui-kit-grid ui-kit-grid-1 ui-kit-grid-md-12 ui-kit-gap-base" novalidate>
                                    ...
                                    <div class="ui-kit-column-md-12">
                                        <label class="ui-kit-cluster ui-kit-align-items-center ui-kit-inline-space-2" for="serverTerms">
                                            ...
                                            <span class="ui-kit-ink-danger"><?php echo sr_e(sr_t('ui.text.07231b0d')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></span>
                                        </label>
                                        <p class="ui-kit-ink-danger ui-kit-space-before-1 ui-kit-type-2xs"><?php echo sr_e(sr_t('ui.text.e3bc5fd9')); ?></p>
                                    </div>
                            ...
                            <div class="card-body">
                                <form class="ui-kit-stack-6" novalidate>
                                    ...
                                    <div>
                                        ...
                                        <p class="ui-kit-ink-danger ui-kit-space-before-1 ui-kit-type-2xs"><?php echo sr_e(sr_t('ui.text.e7b2bd4a')); ?></p>
                                    </div>
                                    ...
                                    <div class="ui-kit-cluster ui-kit-align-items-start ui-kit-gap-2">
                                        ...
                                        <div>
                                            <label for="validationFormCheck1" class="ui-kit-ink-danger"><?php echo sr_e(sr_t('ui.text.31cc6171')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <p class="ui-kit-ink-danger ui-kit-space-before-1 ui-kit-type-2xs"><?php echo sr_e(sr_t('ui.text.3388da7e')); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ui-kit-stack-2">
                                        <div class="ui-kit-cluster ui-kit-align-items-center ui-kit-gap-2">
                                            ...
                                            <label for="validationFormCheck2" class="ui-kit-ink-danger"><?php echo sr_e(sr_t('ui.text.724f8e18')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                        </div>

                                        <div class="ui-kit-cluster ui-kit-align-items-center ui-kit-gap-2">
                                            <input id="validationFormCheck3" type="radio" name="radio-stacked" required
                                                class="form-radio form-choice-danger form-choice-invalid" />
                                            <label for="validationFormCheck3" class="ui-kit-ink-danger"><?php echo sr_e(sr_t('ui.text.2407692e')); ?> <span class="sr-required-label"><?php echo sr_e(sr_t('ui.required.1f227c67')); ?></span></label>
                                            <p class="ui-kit-ink-danger ui-kit-space-before-1 ui-kit-type-2xs"><?php echo sr_e(sr_t('ui.text.6905bf2e')); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="ui-kit-ink-danger ui-kit-space-before-1 ui-kit-type-2xs"><?php echo sr_e(sr_t('ui.text.8bce73cb')); ?></p>
                                    </div>
