...
운영자 관점의 기능과 편의는 [산란 특장점 소개](docs/operator-feature-list.md)에 따로 정리합니다. 이 문서는 제품 소개, 운영자 안내, 신입 담당자 인수인계 자료에 바로 활용할 수 있도록 회원, 콘텐츠, 커뮤니티, 퀴즈, 설문, 자산, 쿠폰, 알림, 개인정보, 사이트 운영 기능을 쉬운 설명으로 묶어 둡니다.
...
| 기능·편의 소개 | [산란 특장점 소개](docs/operator-feature-list.md) |
